    ...
    var n = {
              ...
              \************************************************************************/
                ...
                e.exports = function(e) {
                    var t = o(e, 4),
                        n = t[1],
                        r = t[3];
                    if ("function" != typeof btoa) return [n].join("\n");
                    e = btoa(unescape(encodeURIComponent(JSON.stringify(r)))), t = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(e), e = "/*# ".concat(t, " */"), t = r.sources.map(function(e) {
            ...
            /*!********************************!*\
              ...
              \********************************/
                ...
                ! function() {
                    ...
                    var t = function(e) {
                        var t, n = e && e.color && e.color.replace(/\s/g, "").toLowerCase() || "#f00",
                            r = e && e.format && e.format.replace(/\s/g, "").toLowerCase() || "rgb",
                            o = -1 == r.indexOf("rgba") ? 0 : 1,
                            e = -1 == r.indexOf("hsla") ? 0 : 1;
                        if (-1 < n.indexOf("#")) "hex" == r ? (t = this.hexToRgb(n), t = this.rgbToHex(t)) : -1 < r.indexOf("rgb") ? t = this.hexToRgb(n, o) : -1 < r.indexOf("hsl") && (t = this.hexToRgb(n), t = this.rgbToHsl(t, e));
                        else if (-1 < n.indexOf("rgb")) t = this.getRgb(n, o), "hex" == r ? t = this.rgbToHex(t) : -1 < r.indexOf("hsl") && (t = this.rgbToHsl(t, e));
                        else if (-1 < n.indexOf("hsl")) t = this.getHsl(n, e), t = this.hslToRgb(t, o), "hex" == r ? t = this.rgbToHex(t) : -1 < r.indexOf("hsl") && (t = this.rgbToHsl(t, e));
                        else {
                            ...
                            "hex" == r ? (t = this.hexToRgb(i), t = this.rgbToHex(t)) : -1 < r.indexOf("rgb") ? t = this.hexToRgb(i, o) : -1 < r.indexOf("hsl") && (t = this.hexToRgb(i), t = this.rgbToHsl(t, e))
                        }
                        return t
                    };
                    t.prototype = {
                            ...
                            rgbToHex: function(e) {
                                ...
                                return t.length < 2 && (t = 0 + t), n.length < 2 && (n = 0 + n), r.length < 2 && (r = 0 + r), o.length < 2 && (o = 0 + o), t[0] == t[1] && n[0] == n[1] && r[0] == r[1] && (o[0], o[1]), {
                                    r: t,
                                    g: n,
                                    b: r,
                                    o: o,
                            ...
                            hexToRgb: function(e, t) {
                                ...
                                return 3 == e.length ? (n = parseInt(a[0] + a[0], 16), r = parseInt(a[1] + a[1], 16), o = parseInt(a[2] + a[2], 16), i = 1) : 4 == e.length ? (n = parseInt(a[0] + a[0], 16), r = parseInt(a[1] + a[1], 16), o = parseInt(a[2] + a[2], 16), i = Math.round(parseInt(a[3] + a[3], 16) / 255 * 100) / 100) : 6 == e.length ? (n = parseInt(a[0] + a[1], 16), r = parseInt(a[2] + a[3], 16), o = parseInt(a[4] + a[5], 16), i = 1) : 8 == e.length && (n = parseInt(a[0] + a[1], 16), r = parseInt(a[2] + a[3], 16), o = parseInt(a[4] + a[5], 16), i = Math.round(parseInt(a[6] + a[7], 16) / 255 * 100) / 100), {
                                    r: n,
                                    g: r,
                                    b: o,
                                    o: i,
            ...
            /*!***************************!*\
              ...
              \***************************/
                ...
                e = "undefined" != typeof window ? window : void 0, t = function(h, e) {
                    function t(e, t) {
                    ...
                    C.fn = C.prototype = {
                        ...
                        var e, t, n, r, o, i = arguments[0] || {},
                            ...
                            s = arguments.length,
                            l = !1;
                        for ("boolean" == typeof i && (l = i, i = arguments[a] || {}, a++), "object" == (void 0 === i ? "undefined" : on(i)) || C.isFunction(i) || (i = {}), a === s && (i = this, a--); a < s; a++)
                            if (null != (r = arguments[a]))
                                for (n in r) o = i[n], i !== (t = r[n]) && (l && t && (C.isPlainObject(t) || (e = C.isArray(t))) ? (o = e ? (e = !1, o && C.isArray(o) ? o : []) : o && C.isPlainObject(o) ? o : {}, i[n] = C.extend(l, o, t)) : void 0 !== t && (i[n] = t));
                        return i
                    }, C.extend({
                        ...
                        makeArray: function(e, t) {
                            t = t || [];
                            return null != e && (c(Object(e)) ? C.merge(t, "string" == typeof e ? [e] : e) : s.call(t, e)), t
                        },
                        ...
                        proxy: function(e, t) {
                            var n, r;
                            return "string" == typeof t && (r = e[t], t = e, e = r), C.isFunction(e) ? (n = d.call(arguments, 2), (r = function() {
                    ...
                    var p = function(n) {
                        ...
                        var e, f, b, i, r, h, p, g, C, c, d, m, x, o, A, v, a, s, y, B = "sizzle" + +new Date,
                            w = n.document,
                            k = 0,
                            I = 0,
                            l = ie(),
                        ...
                        try {
                            F.apply(j = H.call(w.childNodes), w.childNodes), j[w.childNodes.length].nodeType
                        } catch (e) {
                            F = {
                        ...
                        function oe(e, t, n, r) {
                            ...
                            if ((t ? t.ownerDocument || t : w) !== x && m(t), n = n || [], a = (t = t || x).nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a) return n;
                            if (!r && A) {
                                if (11 !== a && (o = ee.exec(e)))
                                    if (c = o[1]) {
                                        if (9 === a) {
                                            if (!(i = t.getElementById(c)) || !i.parentNode) return n;
                                            if (i.id === c) return n.push(i), n
                                        } else if (t.ownerDocument && (i = t.ownerDocument.getElementById(c)) && y(t, i) && i.id === c) return n.push(i), n
                                    } else {
                                        if (o[2]) return F.apply(n, t.getElementsByTagName(e)), n;
                                        if ((c = o[3]) && f.getElementsByClassName) return F.apply(n, t.getElementsByClassName(c)), n
                                    }
                                if (f.qsa && (!v || !v.test(e))) {
                                    if (d = c = B, u = t, p = 1 !== a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                                        for (l = h(e), (c = t.getAttribute("id")) ? d = c.replace(ne, "\\$&") : t.setAttribute("id", d), d = "[id='" + d + "'] ", s = l.length; s--;) l[s] = d + fe(l[s]);
                                        u = te.test(e) && ue(t.parentNode) || t, p = l.join(",")
                                    }
                                    if (p) try {
                                        return F.apply(n, u.querySelectorAll(p)), n
                                    } catch (e) {} finally {
                        ...
                        for (e in f = oe.support = {}, r = oe.isXML = function(e) {
                                ...
                                return l !== x && 9 === l.nodeType && l.documentElement ? (o = (x = l).documentElement, (e = l.defaultView) && e !== e.top && (e.addEventListener ? e.addEventListener("unload", t, !1) : e.attachEvent && e.attachEvent("onunload", t)), A = !r(l), f.attributes = se(function(e) {
                                    return e.className = "i", !e.getAttribute("className")
                                }), f.getElementsByTagName = se(function(e) {
                                    return e.appendChild(l.createComment("")), !e.getElementsByTagName("*").length
                                }), f.getElementsByClassName = Z.test(l.getElementsByClassName), f.getById = se(function(e) {
                                ...
                                }, a = [], v = [], (f.qsa = Z.test(l.querySelectorAll)) && (se(function(e) {
                                    ...
                                    f.disconnectedMatch = s.call(e, "div"), s.call(e, "[s!='']:x"), a.push("!=", _)
                                }), v = v.length && new RegExp(v.join("|")), a = a.length && new RegExp(a.join("|")), e = Z.test(o.compareDocumentPosition), y = e || Z.test(o.contains) ? function(e, t) {
                                    ...
                                    var n, r = 0,
                                        ...
                                        a = [e],
                                        s = [t];
                                    if (!o || !i) return e === l ? -1 : t === l ? 1 : o ? -1 : i ? 1 : c ? O(c, e) - O(c, t) : 0;
                                ...
                                if ((e.ownerDocument || e) !== x && m(e), t = t.replace(G, "='$1']"), !(!f.matchesSelector || !A || a && a.test(t) || v && v.test(t))) try {
                                    var n = s.call(e, t);
                                    if (n || f.disconnectedMatch || e.document && 11 !== e.document.nodeType) return n
                                } catch (e) {}
                                return 0 < oe(t, x, null, [e]).length
                            }, oe.contains = function(e, t) {
                                return (e.ownerDocument || e) !== x && m(e), y(e, t)
                                ...
                                var t, n = [],
                                    r = 0,
                                    o = 0;
                                if (d = !f.detectDuplicates, c = !f.sortStable && e.slice(0), e.sort(E), d) {
                                ...
                                preFilter: {
                                    ATTR: function(e) {
                                        return e[1] = e[1].replace(re, u), e[3] = (e[3] || e[4] || e[5] || "").replace(re, u), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)
                                    },
                                    CHILD: function(e) {
                                ...
                                filter: {
                                    ...
                                    ATTR: function(t, n, r) {
                                        return function(e) {
                                            e = oe.attr(e, t);
                                            return null == e ? "!=" === n : !n || (e += "", "=" === n ? e === r : "!=" === n ? e !== r : "^=" === n ? r && 0 === e.indexOf(r) : "*=" === n ? r && -1 < e.indexOf(r) : "$=" === n ? r && e.slice(-r.length) === r : "~=" === n ? -1 < (" " + e.replace(P, " ") + " ").indexOf(r) : "|=" === n && (e === r || e.slice(0, r.length + 1) === r + "-"))
                                        }
                                    },
                                    CHILD: function(f, e, t, h, g) {
                                        ...
                                        return 1 === h && 0 === g ? function(e) {
                                            ...
                                            var r, o, i, a, s, l, c = m != A ? "nextSibling" : "previousSibling",
                                                d = e.parentNode,
                                            ...
                                            if (d) {
                                                if (m) {
                                                    for (; c;) {
                                                        for (i = e; i = i[c];)
                                                            if (v ? i.nodeName.toLowerCase() === u : 1 === i.nodeType) return !1;
                                                        l = c = "only" === f && !l && "nextSibling"
                                                    }
                                                    return !0
                                                }
                                                if (l = [A ? d.firstChild : d.lastChild], A && p) {
                                                    for (s = (r = (o = d[B] || (d[B] = {}))[f] || [])[0] === k && r[1], a = r[0] === k && r[2], i = s && d.childNodes[s]; i = ++s && i && i[c] || (a = s = 0) || l.pop();)
                                                        if (1 === i.nodeType && ++a && i === e) {
                                                            o[f] = [k, s, a];
                                                            break
                                                        }
                                                } else if (p && (r = (e[B] || (e[B] = {}))[f]) && r[0] === k) a = r[1];
                                                else
                                                    for (;
                                                        (i = ++s && i && i[c] || (a = s = 0) || l.pop()) && ((v ? i.nodeName.toLowerCase() !== u : 1 !== i.nodeType) || !++a || (p && ((i[B] || (i[B] = {}))[f] = [k, a]), i !== e)););
                                    ...
                                    PSEUDO: function(e, i) {
                                        ...
                                        return a[B] ? a(i) : 1 < a.length ? (t = [e, e, "", i], b.setFilters.hasOwnProperty(e.toLowerCase()) ? ae(function(e, t) {
                                ...
                                pseudos: {
                                    ...
                                    lang: ae(function(n) {
                                        return V.test(n || "") || oe.error("unsupported lang: " + n), n = n.replace(re, u).toLowerCase(),
                                            function(e) {
                                                var t;
                                                do {
                        ...
                        function he(a, e, t) {
                            ...
                            return e.first ? function(e, t, n) {
                                ...
                                if (n) {
                                    ...
                                    for (; e = e[s];)
                                        if (1 === e.nodeType || l) {
                                            if ((r = (o = e[B] || (e[B] = {}))[s]) && r[0] === k && r[1] === c) return i[2] = r[2];
                        ...
                        function Ae(f, h, g, m, A, e) {
                            return m && !m[B] && (m = Ae(m)), A && !A[B] && (A = Ae(A, e)), ae(function(e, t, n, r) {
                                var o, i, a, s = [],
                                    l = [],
                                    c = t.length,
                                    d = e || function(e, t, n) {
                                    ...
                                    u = !f || !e && h ? d : me(d, s, f, n, r),
                                    p = g ? A || (e ? f : c || m) ? [] : t : u;
                                if (g && g(u, p, n, r), m)
                                    for (o = me(p, l), m(o, [], n, r), i = o.length; i--;)(a = o[i]) && (p[l[i]] = !(u[l[i]] = a));
                                if (e) {
                                    if (A || f) {
                                        if (A) {
                                            for (o = [], i = p.length; i--;)(a = p[i]) && o.push(u[i] = a);
                                            A(null, p = [], o, r)
                                        }
                                        for (i = p.length; i--;)(a = p[i]) && -1 < (o = A ? O(e, a) : s[i]) && (e[o] = !(t[o] = a))
                                    }
                                } else p = me(p === t ? p.splice(c, p.length) : p), A ? A(null, t, p, r) : F.apply(t, p)
                            })
                        }
                        ...
                        function ve(m, A) {
                            function e(e, t, n, r, o) {
                                ...
                                for (o && (C = t !== x && t); c !== g && null != (i = f[c]); c++) {
                                    ...
                                    v && ((i = !s && i) && l--, e && d.push(i))
                                }
                                if (l += c, v && c !== l) {
                                    for (a = 0; s = A[a++];) s(d, u, t, n);
                                    if (e) {
                                        if (0 < l)
                                            for (; c--;) d[c] || u[c] || (u[c] = D.call(r));
                                        u = me(u)
                                    }
                                    F.apply(r, u), o && !e && 0 < u.length && 1 < l + A.length && oe.uniqueSort(r)
                                }
                                return o && (k = h, C = p), d
                            }
                            var v = 0 < A.length,
                        ...
                        return pe.prototype = b.filters = b.pseudos, b.setFilters = new pe, h = oe.tokenize = function(e, t) {
                            var n, r, o, i, a, s, l, c = T[e + " "];
                            if (c) return t ? 0 : c.slice(0);
                            for (a = e, s = [], l = b.preFilter; a;) {
                                for (i in n && !(r = X.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(o = [])), n = !1, (r = $.exec(a)) && (n = r.shift(), o.push({
                                        value: n,
                                        type: r[0].replace(U, " ")
                                    }), a = a.slice(n.length)), b.filter) !(r = Q[i].exec(a)) || l[i] && !(r = l[i](r)) || (n = r.shift(), o.push({
                                    value: n,
                                    type: i,
                                    matches: r
                                }), a = a.slice(n.length));
                            ...
                            if (!i) {
                                for (n = (t = t || h(e)).length; n--;)((i = function e(t) {
                                    for (var r, n, o, i = t.length, a = b.relative[t[0].type], s = a || b.relative[" "], l = a ? 1 : 0, c = he(function(e) {
                                            ...
                                            return n = !a && (n || t !== C) || ((r = t).nodeType ? c : d)(e, t, n), r = null, n
                                        }]; l < i; l++)
                                        if (n = b.relative[t[l].type]) u = [he(ge(u), n)];
                                        else {
                            ...
                            var o, i, a, s, l, c = "function" == typeof e && e,
                                d = !r && h(e = c.selector || e);
                            if (n = n || [], 1 === d.length) {
                                if (2 < (i = d[0] = d[0].slice(0)).length && "ID" === (a = i[0]).type && f.getById && 9 === t.nodeType && A && b.relative[i[1].type]) {
                                    if (!(t = (b.find.ID(a.matches[0].replace(re, u), t) || [])[0])) return n;
                                    c && (t = t.parentNode), e = e.slice(i.shift().value.length)
                                }
                                for (o = Q.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !b.relative[s = a.type]);)
                                    if ((l = b.find[s]) && (r = l(a.matches[0].replace(re, u), te.test(i[0].type) && ue(t.parentNode) || t))) {
                                        if (i.splice(o, 1), !(e = r.length && fe(i))) return F.apply(n, r), n;
                                        break
                                    }
                            }
                            return (c || p(e, d))(r, t, !A, n, te.test(e) && ue(t.parentNode) || t), n
                        }, f.sortStable = B.split("").sort(E).join("") === B, f.detectDuplicates = !!d, m(), f.sortDetached = se(function(e) {
                    ...
                    function b(e, n, r) {
                        ...
                        if ("string" == typeof n) {
                            if (y.test(n)) return C.filter(n, e, r);
                            n = C.filter(n, e)
                        }
                    ...
                    (C.fn.init = function(e, t) {
                        var n, r;
                        if (!e) return this;
                        if ("string" != typeof e) return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : C.isFunction(e) ? void 0 !== x.ready ? x.ready(e) : e(C) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), C.makeArray(e, this));
                        if (!(n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [null, e, null] : w.exec(e)) || !n[1] && t) return (!t || t.jquery ? t || x : this.constructor(t)).find(e);
                        if (n[1]) {
                            if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : B, !0)), v.test(n[1]) && C.isPlainObject(t))
                    ...
                    C.extend({
                        dir: function(e, t, n) {
                            for (var r = [], o = e[t]; o && 9 !== o.nodeType && (void 0 === n || 1 !== o.nodeType || !C(o).is(n));) 1 === o.nodeType && r.push(o), o = o[t];
                            return r
                        },
                        ...
                        C.fn[r] = function(e, t) {
                            ...
                            return (t = "Until" !== r.slice(-5) ? e : t) && "string" == typeof t && (n = C.filter(t, n)), 1 < this.length && (I[r] || (n = C.unique(n)), k.test(r) && (n = n.reverse())), this.pushStack(n)
                        }
                    });
                    var S, E = /\S+/g,
                        N = {};
                    ...
                    function j() {
                        B.addEventListener ? (B.removeEventListener("DOMContentLoaded", D, !1), h.removeEventListener("load", D, !1)) : (B.detachEvent("onreadystatechange", D), h.detachEvent("onload", D))
                    }

                    function D() {
                        !B.addEventListener && "load" !== event.type && "complete" !== B.readyState || (j(), C.ready())
                    }
                    C.Callbacks = function(o) {
                        var e, n;
                        o = "string" == typeof o ? N[o] || (n = N[e = o] = {}, C.each(e.match(E) || [], function(e, t) {
                            n[t] = !0
                        }), n) : C.extend({}, o);

                        function r(e) {
                            for (t = o.memory && e, a = !0, l = c || 0, c = 0, s = d.length, i = !0; d && l < s; l++)
                                if (!1 === d[l].apply(e[0], e[1]) && o.stopOnFalse) {
                                    t = !1;
                                    break
                                }
                            i = !1, d && (u ? u.length && r(u.shift()) : t ? d = [] : p.disable())
                        }
                        var i, t, a, s, l, c, d = [],
                            u = !o.once && [],
                            p = {
                                add: function() {
                                    var e;
                                    return d && (e = d.length, function r(e) {
                                        C.each(e, function(e, t) {
                                            var n = C.type(t);
                                            "function" === n ? o.unique && p.has(t) || d.push(t) : t && t.length && "string" !== n && r(t)
                                        })
                                    }(arguments), i ? s = d.length : t && (c = e, r(t))), this
                                },
                                remove: function() {
                                    return d && C.each(arguments, function(e, t) {
                                        for (var n; - 1 < (n = C.inArray(t, d, n));) d.splice(n, 1), i && (n <= s && s--, n <= l && l--)
                                    }), this
                                },
                                has: function(e) {
                                ...
                                fireWith: function(e, t) {
                                    return !d || a && !u || (t = [e, (t = t || []).slice ? t.slice() : t], i ? u.push(t) : r(t)), this
                                },
                                fire: function() {
                        ...
                        Deferred: function(e) {
                            var i = [
                                ...
                                s = {};
                            return a.pipe = a.then, C.each(i, function(e, t) {
                                var n = t[2],
                                    r = t[3];
                        ...
                        when: function(e) {
                            function t(t, n, r) {
                                return function(e) {
                                    n[t] = this, r[t] = 1 < arguments.length ? d.call(arguments) : e, r === o ? c.notifyWith(n, r) : --l || c.resolveWith(n, r)
                                }
                            }
                            var o, n, r, i = 0,
                                a = d.call(arguments),
                                ...
                                c = 1 === l ? e : C.Deferred();
                            if (1 < s)
                                for (o = new Array(s), n = new Array(s), r = new Array(s); i < s; i++) a[i] && C.isFunction(a[i].promise) ? a[i].promise().done(t(i, r, a)).fail(c.reject).progress(t(i, n, o)) : --l;
                        ...
                        ready: function(e) {
                            if (!0 === e ? !--C.readyWait : !C.isReady) {
                                if (!B.body) return setTimeout(C.ready);
                                (C.isReady = !0) !== e && 0 < --C.readyWait || (S.resolveWith(B, [C]), C.fn.triggerHandler && (C(B).triggerHandler("ready"), C(B).off("ready")))
                            }
                        }
                    }), C.ready.promise = function(e) {
                        if (!S)
                            if (S = C.Deferred(), "complete" === B.readyState) setTimeout(C.ready);
                            else if (B.addEventListener) B.addEventListener("DOMContentLoaded", D, !1), h.addEventListener("load", D, !1);
                        else {
                            B.attachEvent("onreadystatechange", D), h.attachEvent("onload", D);
                            var n = !1;
                            try {
                    ...
                    var L, F = "undefined";
                    for (L in C(A)) break;
                    A.ownLast = "0" !== L, A.inlineBlockNeedsLayout = !1, C(function() {
                    ...
                    function R(e, t, n, r) {
                        if (C.acceptData(e)) {
                            var o, i = C.expando,
                                ...
                                s = a ? C.cache : e,
                                l = a ? e[i] : e[i] && i;
                            if (l && s[l] && (r || s[l].data) || void 0 !== n || "string" != typeof t) return s[l = l || (a ? e[i] = u.pop() || C.guid++ : i)] || (s[l] = a ? {} : {
                                toJSON: C.noop
                            }), "object" != (void 0 === t ? "undefined" : on(t)) && "function" != typeof t || (r ? s[l] = C.extend(s[l], t) : s[l].data = C.extend(s[l].data, t)), l = s[l], r || (l.data || (l.data = {}), l = l.data), void 0 !== n && (l[C.camelCase(t)] = n), "string" == typeof t ? null == (o = l[t]) && (o = l[C.camelCase(t)]) : o = l, o
                        }
                    }
                    ...
                    function W(e, t, n) {
                        if (C.acceptData(e)) {
                            var r, o, i = e.nodeType,
                                a = i ? C.cache : e,
                                s = i ? e[C.expando] : C.expando;
                            if (a[s]) {
                                if (t && (r = n ? a[s] : a[s].data)) {
                                    o = (t = C.isArray(t) ? t.concat(C.map(t, C.camelCase)) : t in r ? [t] : (t = C.camelCase(t)) in r ? [t] : t.split(" ")).length;
                                    for (; o--;) delete r[t[o]];
                                    if (n ? !q(r) : !C.isEmptyObject(r)) return
                                }(n || (delete a[s].data, q(a[s]))) && (i ? C.cleanData([e], !0) : A.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
                            }
                        }
                    }
                    C.extend({
                        ...
                        data: function(e, t) {
                            var n, r, o, i = this[0],
                                a = i && i.attributes;
                            if (void 0 !== e) return "object" == (void 0 === e ? "undefined" : on(e)) ? this.each(function() {
                                C.data(this, e)
                            }) : 1 < arguments.length ? this.each(function() {
                                C.data(this, e, t)
                            }) : i ? M(i, e, C.data(i, e)) : void 0;
                            if (this.length && (o = C.data(i), 1 === i.nodeType && !C._data(i, "parsedAttrs"))) {
                                for (n = a.length; n--;) a[n] && (0 === (r = a[n].name).indexOf("data-") && M(i, r = C.camelCase(r.slice(5)), o[r]));
                        ...
                        promise: function(e, t) {
                            ...
                            var r, o = 1,
                                ...
                                a = this,
                                s = this.length;
                            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(r = C._data(a[s], e + "queueHooks")) && r.empty && (o++, r.empty.add(n));
                    ...
                    var _ = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
                        ...
                        U = C.access = function(e, t, n, r, o, i, a) {
                            ...
                            else if (void 0 !== r && (o = !0, C.isFunction(r) || (a = !0), t = c ? a ? (t.call(e, r), null) : (c = t, function(e, t, n) {
                                    return c.call(C(e), n)
                                }) : t))
                    ...
                    ! function() {
                        ...
                        if (t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", A.leadingWhitespace = 3 === t.firstChild.nodeType, A.tbody = !t.getElementsByTagName("tbody").length, A.htmlSerialize = !!t.getElementsByTagName("link").length, A.html5Clone = "<:nav></:nav>" !== B.createElement("nav").cloneNode(!0).outerHTML, e.type = "checkbox", e.checked = !0, n.appendChild(e), A.appendChecked = e.checked, t.innerHTML = "<textarea>x</textarea>", A.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue, n.appendChild(t), t.innerHTML = "<input type='radio' checked='checked' name='t'/>", A.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, A.noCloneEvent = !0, t.attachEvent && (t.attachEvent("onclick", function() {
                                A.noCloneEvent = !1
                            }), t.cloneNode(!0).click()), null == A.deleteExpando) {
                            A.deleteExpando = !0;
                            try {
                                delete t.test
                            } catch (e) {
                    ...
                    function() {
                        ...
                        for (e in {
                                ...
                                change: !0,
                                focusin: !0
                            }) t = "on" + e, (A[e + "Bubbles"] = t in h) || (n.setAttribute(t, "t"), A[e + "Bubbles"] = !1 === n.attributes[t].expando);
                        n = null
                    }();
                    ...
                    C.event = {
                        ...
                        add: function(e, t, n, r, o) {
                            ...
                            if (h) {
                                for (n.handler && (n = (s = n).handler, o = s.selector), n.guid || (n.guid = C.guid++), (i = h.events) || (i = h.events = {}), (c = h.handle) || ((c = h.handle = function(e) {
                                        return (void 0 === C ? "undefined" : on(C)) === F || e && C.event.triggered === e.type ? void 0 : C.event.dispatch.apply(c.elem, arguments)
                                    }).elem = e), a = (t = (t || "").match(E) || [""]).length; a--;) u = f = (d = Q.exec(t[a]) || [])[1], p = (d[2] || "").split(".").sort(), u && (l = C.event.special[u] || {}, u = (o ? l.delegateType : l.bindType) || u, l = C.event.special[u] || {}, d = C.extend({
                                    type: u,
                                    origType: f,
                                    data: r,
                                    handler: n,
                                    ...
                                    namespace: p.join(".")
                                }, s), (f = i[u]) || ((f = i[u] = []).delegateCount = 0, l.setup && !1 !== l.setup.call(e, r, p, c) || (e.addEventListener ? e.addEventListener(u, c, !1) : e.attachEvent && e.attachEvent("on" + u, c))), l.add && (l.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, d) : f.push(d), C.event.global[u] = !0);
                                e = null
                            }
                        },
                        remove: function(e, t, n, r, o) {
                            ...
                            if (m && (d = m.events)) {
                                for (c = (t = (t || "").match(E) || [""]).length; c--;)
                                    if (f = g = (s = Q.exec(t[c]) || [])[1], h = (s[2] || "").split(".").sort(), f) {
                                        for (u = C.event.special[f] || {}, p = d[f = (r ? u.delegateType : u.bindType) || f] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = i = p.length; i--;) a = p[i], !o && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(i, 1), a.selector && p.delegateCount--, u.remove && u.remove.call(e, a));
                                        l && !p.length && (u.teardown && !1 !== u.teardown.call(e, h, m.handle) || C.removeEvent(e, f, m.handle), delete d[f])
                                    } else
                                        for (f in d) C.event.remove(e, f + t[c], n, r, !0);
                                C.isEmptyObject(d) && (delete m.handle, C._removeData(e, "events"))
                            }
                        },
                        trigger: function(e, t, n, r) {
                            var o, i, a, s, l, c, d = [n || B],
                                u = m.call(e, "type") ? e.type : e,
                                p = m.call(e, "namespace") ? e.namespace.split(".") : [],
                                f = l = n = n || B;
                            if (3 !== n.nodeType && 8 !== n.nodeType && !V.test(u + C.event.triggered) && (0 <= u.indexOf(".") && (u = (p = u.split(".")).shift(), p.sort()), i = u.indexOf(":") < 0 && "on" + u, (e = e[C.expando] ? e : new C.Event(u, "object" == (void 0 === e ? "undefined" : on(e)) && e)).isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), s = C.event.special[u] || {}, r || !s.trigger || !1 !== s.trigger.apply(n, t))) {
                                if (!r && !s.noBubble && !C.isWindow(n)) {
                                    for (a = s.delegateType || u, V.test(a + u) || (f = f.parentNode); f; f = f.parentNode) d.push(f), l = f;
                                    l === (n.ownerDocument || B) && d.push(l.defaultView || l.parentWindow || h)
                                }
                                for (c = 0;
                                    (f = d[c++]) && !e.isPropagationStopped();) e.type = 1 < c ? a : s.bindType || u, (o = (C._data(f, "events") || {})[e.type] && C._data(f, "handle")) && o.apply(f, t), (o = i && f[i]) && o.apply && C.acceptData(f) && (e.result = o.apply(f, t), !1 === e.result && e.preventDefault());
                                if (e.type = u, !r && !e.isDefaultPrevented() && (!s._default || !1 === s._default.apply(d.pop(), t)) && C.acceptData(n) && i && n[u] && !C.isWindow(n)) {
                                    (l = n[i]) && (n[i] = null), C.event.triggered = u;
                                    try {
                                        n[u]()
                                    } catch (e) {}
                                    C.event.triggered = void 0, l && (n[i] = l)
                                }
                                return e.result
                            }
                        },
                        dispatch: function(e) {
                            e = C.event.fix(e);
                            var t, n, r, o, i, a = d.call(arguments),
                            ...
                            if ((a[0] = e).delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                                for (i = C.event.handlers.call(this, e, s), t = 0;
                                    (r = i[t++]) && !e.isPropagationStopped();)
                                    for (e.currentTarget = r.elem, o = 0;
                                        (n = r.handlers[o++]) && !e.isImmediatePropagationStopped();) e.namespace_re && !e.namespace_re.test(n.namespace) || (e.handleObj = n, e.data = n.data, void 0 !== (n = ((C.event.special[n.origType] || {}).handle || n.handler).apply(r.elem, a)) && !1 === (e.result = n) && (e.preventDefault(), e.stopPropagation()));
                            ...
                            if (s && l.nodeType && (!e.button || "click" !== e.type))
                                for (; l != this; l = l.parentNode || this)
                                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                                        for (o = [], i = 0; i < s; i++) void 0 === o[n = (r = t[i]).selector + " "] && (o[n] = r.needsContext ? 0 <= C(n, this).index(l) : C.find(n, this, null, [l]).length), o[n] && o.push(r);
                                        o.length && a.push({
                                            elem: l,
                                            handlers: o
                                        })
                        ...
                        fix: function(e) {
                            ...
                            var t, n, r, o = e.type,
                                i = e,
                                a = this.fixHooks[o];
                            for (a || (this.fixHooks[o] = a = Y.test(o) ? this.mouseHooks : G.test(o) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new C.Event(i), t = r.length; t--;) e[n = r[t]] = i[n];
                            return e.target || (e.target = i.srcElement || B), 3 === e.target.nodeType && (e.target = e.target.parentNode), e.metaKey = !!e.metaKey, a.filter ? a.filter(e, i) : e
                        },
                        ...
                        simulate: function(e, t, n, r) {
                            ...
                            r ? C.event.trigger(e, null, t) : C.event.dispatch.call(t, e), e.isDefaultPrevented() && n.preventDefault()
                        }
                    }, C.removeEvent = B.removeEventListener ? function(e, t, n) {
                        e.removeEventListener && e.removeEventListener(t, n, !1)
                    } : function(e, t, n) {
                        t = "on" + t;
                        e.detachEvent && (on(e[t]) === F && (e[t] = null), e.detachEvent(t, n))
                    }, C.Event = function(e, t) {
                        return this instanceof C.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? K : J) : this.type = e, t && C.extend(this, t), this.timeStamp = e && e.timeStamp || C.now(), void(this[C.expando] = !0)) : new C.Event(e, t)
                    }, C.Event.prototype = {
                        ...
                        setup: function() {
                            return !C.nodeName(this, "form") && void C.event.add(this, "click._submit keypress._submit", function(e) {
                                e = e.target, e = C.nodeName(e, "input") || C.nodeName(e, "button") ? e.form : void 0;
                        ...
                        teardown: function() {
                            return C.event.remove(this, "._change"), !$.test(this.nodeName)
                        }
                        ...
                        C.event.special[r] = {
                            setup: function() {
                                var e = this.ownerDocument || this,
                                    t = C._data(e, r);
                                t || e.addEventListener(n, o, !0), C._data(e, r, (t || 0) + 1)
                            },
                            teardown: function() {
                                var e = this.ownerDocument || this,
                                    t = C._data(e, r) - 1;
                                t ? C._data(e, r, t) : (e.removeEventListener(n, o, !0), C._removeData(e, r))
                            }
                        }
                    }), C.fn.extend({
                        on: function(e, t, n, r, o) {
                            ...
                            if ("object" == (void 0 === e ? "undefined" : on(e))) {
                                for (i in "string" != typeof t && (n = n || t, t = void 0), e) this.on(i, t, n, e[i], o);
                                return this
                            }
                            if (null == n && null == r ? (r = t, n = t = void 0) : null == r && ("string" == typeof t ? (r = n, n = void 0) : (r = n, n = t, t = void 0)), !1 === r) r = J;
                        ...
                        off: function(e, t, n) {
                            ...
                            if ("object" != (void 0 === e ? "undefined" : on(e))) return !1 !== t && "function" != typeof t || (n = t, t = void 0), !1 === n && (n = J), this.each(function() {
                    ...
                    function me(e, t) {
                        var n, r, o = 0,
                            i = on(e.getElementsByTagName) !== F ? e.getElementsByTagName(t || "*") : on(e.querySelectorAll) !== F ? e.querySelectorAll(t || "*") : void 0;
                        if (!i)
                            for (i = [], n = e.childNodes || e; null != (r = n[o]); o++) !t || C.nodeName(r, t) ? i.push(r) : C.merge(i, me(r, t));
                    ...
                    function xe(e, t) {
                        if (1 === t.nodeType && C.hasData(e)) {
                            var n, r, o, i = C._data(e),
                                e = C._data(t, i),
                                a = i.events;
                            if (a)
                                for (n in delete e.handle, e.events = {}, a)
                                    for (r = 0, o = a[n].length; r < o; r++) C.event.add(t, n, a[n][r]);
                            e.data && (e.data = C.extend({}, e.data))
                        }
                    }
                    he.optgroup = he.option, he.tbody = he.tfoot = he.colgroup = he.caption = he.thead, he.th = he.td, C.extend({
                        clone: function(e, t, n) {
                            var r, o, i, a, s, l = C.contains(e.ownerDocument, e);
                            if (A.html5Clone || C.isXMLDoc(e) || !re.test("<" + e.nodeName + ">") ? i = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML, ge.removeChild(i = ge.firstChild)), !(A.noCloneEvent && A.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                                for (r = me(i), s = me(e), a = 0; null != (o = s[a]); ++a) r[a] && function(e, t) {
                                    var n, r, o;
                                    if (1 === t.nodeType) {
                                        if (n = t.nodeName.toLowerCase(), !A.noCloneEvent && t[C.expando]) {
                                            for (r in (o = C._data(t)).events) C.removeEvent(t, r, o.handle);
                            ...
                            if (t)
                                if (n)
                                    for (s = s || me(e), r = r || me(i), a = 0; null != (o = s[a]); a++) xe(o, r[a]);
                                else xe(e, i);
                            return 0 < (r = me(i, "script")).length && Ce(r, !l && me(e, "script")), r = s = o = null, i
                        },
                        buildFragment: function(e, t, n, r) {
                            for (var o, i, a, s, l, c, d, u = e.length, p = ee(t), f = [], h = 0; h < u; h++)
                                ...
                                for (s = s || p.appendChild(t.createElement("div")), l = (ae.exec(i) || ["", ""])[1].toLowerCase(), d = he[l] || he._default, s.innerHTML = d[1] + i.replace(ie, "<$1></$2>") + d[2], o = d[0]; o--;) s = s.lastChild;
                                if (!A.leadingWhitespace && oe.test(i) && f.push(t.createTextNode(oe.exec(i)[0])), !A.tbody)
                                    for (o = (i = "table" !== l || se.test(i) ? "<table>" !== d[1] || se.test(i) ? 0 : s : s.firstChild) && i.childNodes.length; o--;) C.nodeName(c = i.childNodes[o], "tbody") && !c.childNodes.length && i.removeChild(c);
                                for (C.merge(f, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                                s = p.lastChild
                            } else f.push(t.createTextNode(i));
                            for (s && p.removeChild(s), A.appendChecked || C.grep(me(f, "input"), Ae), h = 0; i = f[h++];)
                                if ((!r || -1 === C.inArray(i, r)) && (a = C.contains(i.ownerDocument, i), s = me(p.appendChild(i), "script"), a && Ce(s), n))
                        ...
                        cleanData: function(e, t) {
                            for (var n, r, o, i, a = 0, s = C.expando, l = C.cache, c = A.deleteExpando, d = C.event.special; null != (n = e[a]); a++)
                                if ((t || C.acceptData(n)) && (i = (o = n[s]) && l[o])) {
                                    if (i.events)
                                        for (r in i.events) d[r] ? C.event.remove(n, r) : C.removeEvent(n, r, i.handle);
                                    l[o] && (delete l[o], c ? delete n[s] : on(n.removeAttribute) !== F ? n.removeAttribute(s) : n[s] = null, u.push(o))
                                }
                        }
                    }), C.fn.extend({
                        text: function(e) {
                        ...
                        remove: function(e, t) {
                            for (var n, r = e ? C.filter(e, this) : this, o = 0; null != (n = r[o]); o++) t || 1 !== n.nodeType || C.cleanData(me(n)), n.parentNode && (t && C.contains(n.ownerDocument, n) && Ce(me(n, "script")), n.parentNode.removeChild(n));
                            return this
                        },
                        empty: function() {
                            for (var e, t = 0; null != (e = this[t]); t++) {
                                for (1 === e.nodeType && C.cleanData(me(e, !1)); e.firstChild;) e.removeChild(e.firstChild);
                        ...
                        replaceWith: function() {
                            var t = arguments[0];
                            return this.domManip(arguments, function(e) {
                                t = this.parentNode, C.cleanData(me(this)), t && t.replaceChild(e, this)
                        ...
                        domManip: function(n, r) {
                            ...
                            var e, t, o, i, a, s, l = 0,
                                ...
                                p = n[0],
                                f = C.isFunction(p);
                            if (f || 1 < c && "string" == typeof p && !A.checkClone && de.test(p)) return this.each(function(e) {
                                var t = d.eq(e);
                                f && (n[0] = p.call(this, e, t.html())), t.domManip(n, r)
                            });
                            if (c && (e = (s = C.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === s.childNodes.length && (s = e), e)) {
                                for (o = (i = C.map(me(s, "script"), ye)).length; l < c; l++) t = s, l !== u && (t = C.clone(t, !0, !0), o && C.merge(i, me(t, "script"))), r.call(this[l], t, l);
                                if (o)
                                    for (a = i[i.length - 1].ownerDocument, C.map(i, be), l = 0; l < o; l++) t = i[l], ue.test(t.type || "") && !C._data(t, "globalEval") && C.contains(a, t) && (t.src ? C._evalUrl && C._evalUrl(t.src) : C.globalEval((t.text || t.textContent || t.innerHTML || "").replace(fe, "")));
                                s = e = null
                            }
                            return this
                        }
                        ...
                        C.fn[e] = function(e) {
                            for (var t, n = 0, r = [], o = C(e), i = o.length - 1; n <= i; n++) t = n === i ? this : this.clone(!0), C(o[n])[a](t), s.apply(r, t.get());
                    ...
                    function Te(e) {
                        var t = B,
                            n = ke[e];
                        return n || ("none" !== (n = Ie(e, t)) && n || ((t = ((Be = (Be || C("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Be[0].contentDocument).document).write(), t.close(), n = Ie(e, t), Be.detach()), ke[e] = n), n
                    }
                    A.shrinkWrapBlocks = function() {
                        return null != we ? we : (we = !1, (t = B.getElementsByTagName("body")[0]) && t.style ? (e = B.createElement("div"), (n = B.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", t.appendChild(n).appendChild(e), on(e.style.zoom) !== F && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", e.appendChild(B.createElement("div")).style.width = "5px", we = 3 !== e.offsetWidth), t.removeChild(n), we) : void 0);
                        var e, t, n
                    };
                    var Se, Ee, Ne, je, De, Le, Fe = /^margin/,
                        He = new RegExp("^(" + _ + ")(?!px)[a-z%]+$", "i"),
                    ...
                    function qe() {
                        ...
                        r && r.style && (e = B.createElement("div"), (t = B.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", r.appendChild(t).appendChild(e), e.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", Ne = je = !1, Le = !0, h.getComputedStyle && (Ne = "1%" !== (h.getComputedStyle(e, null) || {}).top, je = "4px" === (h.getComputedStyle(e, null) || {
                            width: "4px"
                        }).width, (n = e.appendChild(B.createElement("div"))).style.cssText = e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", e.style.width = "1px", Le = !parseFloat((h.getComputedStyle(n, null) || {}).marginRight), e.removeChild(n)), e.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", (n = e.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none", (De = 0 === n[0].offsetHeight) && (n[0].style.display = "", n[1].style.display = "none", De = 0 === n[0].offsetHeight), r.removeChild(t))
                    }
                    h.getComputedStyle ? (Se = function(e) {
                        ...
                        var r, o = e.style,
                            i = (n = n || Se(e)) ? n.getPropertyValue(t) || n[t] : void 0;
                        return n && ("" !== i || C.contains(e.ownerDocument, e) || (i = C.style(e, t)), He.test(i) && Fe.test(t) && (r = o.width, e = o.minWidth, t = o.maxWidth, o.minWidth = o.maxWidth = o.width = i, i = n.width, o.width = r, o.minWidth = e, o.maxWidth = t)), void 0 === i ? i : i + ""
                    }) : B.documentElement.currentStyle && (Se = function(e) {
                        return e.currentStyle
                    }, Ee = function(e, t, n) {
                        var r, o, i, a = e.style;
                        return null == (i = (n = n || Se(e)) ? n[t] : void 0) && a && a[t] && (i = a[t]), He.test(i) && !Oe.test(t) && (r = a.left, (n = (o = e.runtimeStyle) && o.left) && (o.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : i, i = a.pixelLeft + "px", a.left = r, n && (o.left = n)), void 0 === i ? i : i + "" || "auto"
                    }), (tt = B.createElement("div")).innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", (nt = (nt = tt.getElementsByTagName("a")[0]) && nt.style) && (nt.cssText = "float:left;opacity:.5", A.opacity = "0.5" === nt.opacity, A.cssFloat = !!nt.cssFloat, tt.style.backgroundClip = "content-box", tt.cloneNode(!0).style.backgroundClip = "", A.clearCloneStyle = "content-box" === tt.style.backgroundClip, A.boxSizing = "" === nt.boxSizing || "" === nt.MozBoxSizing || "" === nt.WebkitBoxSizing, C.extend(A, {
                        reliableHiddenOffsets: function() {
                            return null == De && qe(), De
                        },
                        boxSizingReliable: function() {
                            return null == je && qe(), je
                        },
                        pixelPosition: function() {
                            return null == Ne && qe(), Ne
                        },
                        reliableMarginRight: function() {
                            return null == Le && qe(), Le
                        }
                    ...
                    function Ge(e, t) {
                        ...
                        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, o = $e.length; o--;)
                            if ((t = $e[o] + n) in e) return t;
                        return r
                    }

                    function Ye(e, t) {
                        for (var n, r, o, i = [], a = 0, s = e.length; a < s; a++)(r = e[a]).style && (i[a] = C._data(r, "olddisplay"), n = r.style.display, t ? (i[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && z(r) && (i[a] = C._data(r, "olddisplay", Te(r.nodeName)))) : (o = z(r), (n && "none" !== n || !o) && C._data(r, "olddisplay", o ? n : C.css(r, "display"))));
                    ...
                    function Qe(e, t, n, r, o) {
                        for (var i = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; i < 4; i += 2) "margin" === n && (a += C.css(e, n + P[i], !0, o)), r ? ("content" === n && (a -= C.css(e, "padding" + P[i], !0, o)), "margin" !== n && (a -= C.css(e, "border" + P[i] + "Width", !0, o))) : (a += C.css(e, "padding" + P[i], !0, o), "padding" !== n && (a += C.css(e, "border" + P[i] + "Width", !0, o)));
                        return a
                    }
                    ...
                    function Ke(e, t, n) {
                        ...
                        if (o <= 0 || null == o) {
                            if (((o = Ee(e, t, i)) < 0 || null == o) && (o = e.style[t]), He.test(o)) return o;
                            r = a && (A.boxSizingReliable() || o === e.style[t]), o = parseFloat(o) || 0
                        }
                    ...
                    C.extend({
                        ...
                        style: function(e, t, n, r) {
                            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                                var o, i, a, s = C.camelCase(t),
                                    l = e.style;
                                if (t = C.cssProps[s] || (C.cssProps[s] = Ge(l, s)), a = C.cssHooks[t] || C.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, r)) ? o : l[t];
                                if ("string" === (i = void 0 === n ? "undefined" : on(n)) && (o = Pe.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(C.css(e, t)), i = "number"), null != n && n == n && ("number" !== i || C.cssNumber[s] || (n += "px"), A.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
                                    l[t] = n
                                } catch (e) {}
                            }
                        },
                        css: function(e, t, n, r) {
                            ...
                            return t = C.cssProps[i] || (C.cssProps[i] = Ge(e.style, i)), "normal" === (o = void 0 === (o = (i = C.cssHooks[t] || C.cssHooks[i]) && "get" in i ? i.get(e, !0, n) : o) ? Ee(e, t, r) : o) && t in Xe && (o = Xe[t]), "" === n || n ? (t = parseFloat(o), !0 === n || C.isNumeric(t) ? t || 0 : o) : o
                        }
                        ...
                        set: function(e, t) {
                            ...
                            ((n.zoom = 1) <= t || "" === t) && "" === C.trim(e.replace(Re, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = Re.test(e) ? e.replace(Re, o) : e + " " + o)
                        }
                        ...
                        css: function(e, t) {
                            return U(this, function(e, t, n) {
                                var r, o, i = {},
                                    a = 0;
                                if (C.isArray(t)) {
                                    for (r = Se(e), o = t.length; a < o; a++) i[t[a]] = C.css(e, t[a], !1, r);
                                    return i
                                }
                        ...
                        init: function(e, t, n, r, o, i) {
                            this.elem = e, this.prop = n, this.easing = o || "swing", this.options = t, this.start = this.now = this.cur(), this.end = r, this.unit = i || (C.cssNumber[n] ? "" : "px")
                        },
                        cur: function() {
                    ...
                    var Ze, et, tt, nt, rt, ot = /^(?:toggle|show|hide)$/,
                        it = new RegExp("^(?:([+-])=|)(" + _ + ")([a-z%]*)$", "i"),
                        at = /queueHooks$/,
                        st = [function(t, e, n) {
                            var r, o, i, a, s, l, c, d = this,
                                u = {},
                                p = t.style,
                                f = t.nodeType && z(t),
                                h = C._data(t, "fxshow");
                            for (r in n.queue || (null == (s = C._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, l = s.empty.fire, s.empty.fire = function() {
                                ...
                                })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = C.css(t, "display"), "inline" === ("none" === c ? C._data(t, "olddisplay") || Te(t.nodeName) : c) && "none" === C.css(t, "float") && (A.inlineBlockNeedsLayout && "inline" !== Te(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", A.shrinkWrapBlocks() || d.always(function() {
                                    p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                                })), e)
                                if (o = e[r], ot.exec(o)) {
                                    if (delete e[r], i = i || "toggle" === o, o === (f ? "hide" : "show")) {
                                        if ("show" !== o || !h || void 0 === h[r]) continue;
                                        f = !0
                                    }
                                    u[r] = h && h[r] || C.style(t, r)
                                } else c = void 0;
                            if (C.isEmptyObject(u)) "inline" === ("none" === c ? Te(t.nodeName) : c) && (p.display = c);
                            else
                                for (r in h ? "hidden" in h && (f = h.hidden) : h = C._data(t, "fxshow", {}), i && (h.hidden = !f), f ? C(t).show() : d.done(function() {
                                        C(t).hide()
                                    }), d.done(function() {
                                        for (var e in C._removeData(t, "fxshow"), u) C.style(t, e, u[e])
                                    }), u) a = ut(f ? h[r] : 0, r, d), r in h || (h[r] = a.start, f && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
                        }],
                        lt = {
                            "*": [function(e, t) {
                                var n = this.createTween(e, t),
                                    ...
                                    s = 20;
                                if (i && i[3] !== o)
                                    for (o = o || i[3], t = t || [], i = +r || 1; i /= a = a || ".5", C.style(n.elem, e, i + o), a !== (a = n.cur() / r) && 1 !== a && --s;);
                                return t && (i = n.start = +i || +r || 0, n.unit = o, n.end = t[1] ? i + (t[1] + 1) * t[2] : +t[2]), n
                            }]
                        };
                    ...
                    function dt(e, t) {
                        var n, r = {
                            ...
                            o = 0;
                        for (t = t ? 1 : 0; o < 4; o += 2 - t) r["margin" + (n = P[o])] = r["padding" + n] = e;
                    ...
                    function pt(o, e, t) {
                        var n, i, r = 0,
                            ...
                            l = function() {
                                if (i) return !1;
                                for (var e = Ze || ct(), e = Math.max(0, c.startTime + c.duration - e), t = 1 - (e / c.duration || 0), n = 0, r = c.tweens.length; n < r; n++) c.tweens[n].run(t);
                                return s.notifyWith(o, [c, t, e]), t < 1 && r ? e : (s.resolveWith(o, [c]), !1)
                            },
                            c = s.promise({
                                elem: o,
                                props: C.extend({}, e),
                        ...
                        for (function(e, t) {
                                var n, r, o, i, a;
                                for (n in e)
                                    if (o = t[r = C.camelCase(n)], i = e[n], C.isArray(i) && (o = i[1], i = e[n] = i[0]), n !== r && (e[r] = i, delete e[n]), (a = C.cssHooks[r]) && "expand" in a)
                                        for (n in i = a.expand(i), delete e[r], i) n in e || (e[n] = i[n], t[n] = o);
                                    else t[r] = o
                            }(d, c.opts.specialEasing); r < a; r++)
                            if (n = st[r].call(c, o, d, c.opts)) return n;
                        return C.map(d, ut, c), C.isFunction(c.opts.start) && c.opts.start.call(o, c), C.fx.timer(C.extend(l, {
                            elem: o,
                            anim: c,
                            queue: c.opts.queue
                    ...
                    C.Animation = C.extend(pt, {
                        tweener: function(e, t) {
                            for (var n, r = 0, o = (e = C.isFunction(e) ? (t = e, ["*"]) : e.split(" ")).length; r < o; r++) n = e[r], lt[n] = lt[n] || [], lt[n].unshift(t)
                        },
                    ...
                    }, (rt = B.createElement("div")).setAttribute("className", "t"), rt.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", p = rt.getElementsByTagName("a")[0], nt = (tt = B.createElement("select")).appendChild(B.createElement("option")), _ = rt.getElementsByTagName("input")[0], p.style.cssText = "top:1px", A.getSetAttribute = "t" !== rt.className, A.style = /top/.test(p.getAttribute("style")), A.hrefNormalized = "/a" === p.getAttribute("href"), A.checkOn = !!_.value, A.optSelected = nt.selected, A.enctype = !!B.createElement("form").enctype, tt.disabled = !0, A.optDisabled = !nt.disabled, (_ = B.createElement("input")).setAttribute("value", ""), A.input = "" === _.getAttribute("value"), _.value = "t", _.setAttribute("type", "radio"), A.radioValue = "t" === _.value;
                    var ft = /\r/g;
                    C.fn.extend({
                        val: function(t) {
                            var n, e, r, o = this[0];
                            ...
                            select: {
                                ...
                                set: function(e, t) {
                                    for (var n, r, o = e.options, i = C.makeArray(t), a = o.length; a--;)
                                        if (r = o[a], 0 <= C.inArray(C.valHooks.option.get(r), i)) try {
                                            r.selected = n = !0
                                        } catch (e) {
                                            r.scrollHeight
                                        } else r.selected = !1;
                    ...
                    var ht, gt, mt = C.expr.attrHandle,
                        At = /^(?:checked|selected)$/i,
                        vt = A.getSetAttribute,
                        yt = A.input;
                    C.fn.extend({
                        attr: function(e, t) {
                        ...
                        attr: function(e, t, n) {
                            var r, o, i = e.nodeType;
                            if (e && 3 !== i && 8 !== i && 2 !== i) return on(e.getAttribute) === F ? C.prop(e, t, n) : (1 === i && C.isXMLDoc(e) || (t = t.toLowerCase(), r = C.attrHooks[t] || (C.expr.match.bool.test(t) ? gt : ht)), void 0 === n ? r && "get" in r && null !== (o = r.get(e, t)) ? o : null == (o = C.find.attr(e, t)) ? void 0 : o : null !== n ? r && "set" in r && void 0 !== (o = r.set(e, n, t)) ? o : (e.setAttribute(t, n + ""), n) : void C.removeAttr(e, t))
                        },
                        removeAttr: function(e, t) {
                            var n, r, o = 0,
                                i = t && t.match(E);
                            if (i && 1 === e.nodeType)
                                for (; n = i[o++];) r = C.propFix[n] || n, C.expr.match.bool.test(n) ? yt && vt || !At.test(n) ? e[r] = !1 : e[C.camelCase("default-" + n)] = e[r] = !1 : C.attr(e, n, ""), e.removeAttribute(vt ? n : r)
                        },
                        attrHooks: {
                            type: {
                                set: function(e, t) {
                        ...
                        set: function(e, t, n) {
                            return !1 === t ? C.removeAttr(e, n) : yt && vt || !At.test(n) ? e.setAttribute(!vt && C.propFix[n] || n, n) : e[C.camelCase("default-" + n)] = e[n] = !0, n
                        }
                    }, C.each(C.expr.match.bool.source.match(/\w+/g), function(e, t) {
                        var i = mt[t] || C.find.attr;
                        mt[t] = yt && vt || !At.test(t) ? function(e, t, n) {
                            var r, o;
                            return n || (o = mt[t], mt[t] = r, r = null != i(e, t, n) ? t.toLowerCase() : null, mt[t] = o), r
                        } : function(e, t, n) {
                    ...
                    C.fn.extend({
                        ...
                        prop: function(e, t, n) {
                            var r, o, i = e.nodeType;
                            if (e && 3 !== i && 8 !== i && 2 !== i) return (1 !== i || !C.isXMLDoc(e)) && (t = C.propFix[t] || t, o = C.propHooks[t]), void 0 !== n ? o && "set" in o && void 0 !== (r = o.set(e, n, t)) ? r : e[t] = n : o && "get" in o && null !== (r = o.get(e, t)) ? r : e[t]
                        },
                        propHooks: {
                            tabIndex: {
                                get: function(e) {
                    ...
                    C.fn.extend({
                        ...
                        toggleClass: function(o, t) {
                            ...
                            return "boolean" == typeof t && "string" === i ? t ? this.addClass(o) : this.removeClass(o) : this.each(C.isFunction(o) ? function(e) {
                                ...
                                if ("string" === i)
                                    for (var e, t = 0, n = C(this), r = o.match(E) || []; e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                                else i !== F && "boolean" !== i || (this.className && C._data(this, "__className__", this.className), this.className = !this.className && !1 !== o && C._data(this, "__className__") || "")
                            })
                        },
                        hasClass: function(e) {
                            for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
                                if (1 === this[n].nodeType && 0 <= (" " + this[n].className + " ").replace(xt, " ").indexOf(t)) return !0;
                            return !1
                        }
                    ...
                    C.parseJSON = function(e) {
                        ...
                        return t && !C.trim(t.replace(kt, function(e, t, n, r) {
                            return 0 === (i = o && t ? 0 : i) ? e : (o = n || t, i += !r - !n, "")
                    ...
                    function Mt(i) {
                        return function(e, t) {
                            ...
                            if (C.isFunction(t))
                                for (; n = o[r++];) "+" === n.charAt(0) ? (n = n.slice(1) || "*", (i[n] = i[n] || []).unshift(t)) : (i[n] = i[n] || []).push(t)
                        }
                    }
                    ...
                    It = Lt.exec(Tt.toLowerCase()) || [], C.extend({
                        active: 0,
                        lastModified: {},
                        etag: {},
                        ajaxSettings: {
                        ...
                        ajaxTransport: Mt(Ht),
                        ajax: function(e, t) {
                            "object" == (void 0 === e ? "undefined" : on(e)) && (t = e, e = void 0), t = t || {};
                            var n, l, c, d, u, p, r, f = C.ajaxSetup({}, t),
                                h = f.context || f,
                                ...
                                b = {
                                    ...
                                    getResponseHeader: function(e) {
                                        ...
                                        if (2 === y) {
                                            if (!r)
                                                for (r = {}; t = Nt.exec(c);) r[t[1].toLowerCase()] = t[2];
                                            t = r[e.toLowerCase()]
                                        }
                                    ...
                                    setRequestHeader: function(e, t) {
                                        var n = e.toLowerCase();
                                        return y || (e = i[n] = i[n] || e, o[e] = t), this
                                    },
                            ...
                            if (m.promise(b).complete = A.add, b.success = b.done, b.error = b.fail, f.url = ((e || f.url || Tt) + "").replace(St, "").replace(Dt, It[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = C.trim(f.dataType || "*").toLowerCase().match(E) || [""], null == f.crossDomain && (e = Lt.exec(f.url.toLowerCase()), f.crossDomain = !(!e || e[1] === It[1] && e[2] === It[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (It[3] || ("http:" === It[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = C.param(f.data, f.traditional)), qt(Ft, f, t, b), 2 === y) return b;
                            for (n in (u = C.event && f.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !jt.test(f.type), l = f.url, f.hasContent || (f.data && (l = f.url += (wt.test(l) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (f.url = Et.test(l) ? l.replace(Et, "$1_=" + Bt++) : l + (wt.test(l) ? "&" : "?") + "_=" + Bt++)), f.ifModified && (C.lastModified[l] && b.setRequestHeader("If-Modified-Since", C.lastModified[l]), C.etag[l] && b.setRequestHeader("If-None-Match", C.etag[l])), (f.data && f.hasContent && !1 !== f.contentType || t.contentType) && b.setRequestHeader("Content-Type", f.contentType), b.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ot + "; q=0.01" : "") : f.accepts["*"]), f.headers) b.setRequestHeader(n, f.headers[n]);
                            if (f.beforeSend && (!1 === f.beforeSend.call(h, b, f) || 2 === y)) return b.abort();
                            for (n in a = "abort", {
                                    success: 1,
                                    error: 1,
                                    complete: 1
                            ...
                            if (p = qt(Ht, f, t, b)) {
                                b.readyState = 1, u && g.trigger("ajaxSend", [b, f]), f.async && 0 < f.timeout && (d = setTimeout(function() {
                                    b.abort("timeout")
                                }, f.timeout));
                                try {
                                    y = 1, p.send(o, s)
                            ...
                            function s(e, t, n, r) {
                                var o, i, a, s = t;
                                2 !== y && (y = 2, d && clearTimeout(d), p = void 0, c = r || "", b.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (a = function(e, t, n) {
                                ...
                                }(f, b, n)), a = function(e, t, n, r) {
                                    var o, i, a, s, l, c = {},
                                        d = e.dataTypes.slice();
                                    if (d[1])
                                        for (a in e.converters) c[a.toLowerCase()] = e.converters[a];
                                    for (i = d.shift(); i;)
                                        if (e.responseFields[i] && (n[e.responseFields[i]] = t), !l && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = i, i = d.shift())
                                            if ("*" === i) i = l;
                                            else if ("*" !== l && l !== i) {
                                        if (!(a = c[l + " " + i] || c["* " + i]))
                                            for (o in c)
                                                if ((s = o.split(" "))[1] === i && (a = c[l + " " + s[0]] || c["* " + s[0]])) {
                                                    !0 === a ? a = c[o] : !0 !== c[o] && (i = s[0], d.unshift(s[1]));
                                                    break
                                                }
                                        if (!0 !== a)
                                            if (a && e.throws) t = a(t);
                    ...
                    C.param = function(e, t) {
                        ...
                        if (void 0 === t && (t = C.ajaxSettings && C.ajaxSettings.traditional), C.isArray(e) || e.jquery && !C.isPlainObject(e)) C.each(e, function() {
                            ...
                            for (r in e) ! function n(r, e, o, i) {
                                ...
                                else if (o || "object" !== C.type(e)) i(r, e);
                                else
                    ...
                    }), A.cors = !!_ && "withCredentials" in _, (_ = A.ajax = !!_) && C.ajaxTransport(function(l) {
                        var c;
                            ...
                            send: function(e, i) {
                                ...
                                a.send(l.hasContent && l.data || null), c = function(e, t) {
                                    ...
                                    if (c && (t || 4 === a.readyState))
                                        if (delete $t[s], c = void 0, a.onreadystatechange = C.noop, t) 4 !== a.readyState && a.abort();
                                        else {
                    ...
                    C.ajaxSetup({
                        ...
                        return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = C.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Vt, "$1" + r) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
                            return i || C.error(r + " was not called"), i[0]
                        }, e.dataTypes[0] = "json", o = h[r], h[r] = function() {
                            i = arguments
                        }, n.always(function() {
                            h[r] = o, e[r] && (e.jsonpCallback = t.jsonpCallback, Yt.push(r)), i && C.isFunction(o) && o(i[0]), i = o = void 0
                        }), "script") : void 0
                        ...
                        var r = v.exec(e),
                            n = !n && [];
                        return r ? [t.createElement(r[1])] : (r = C.buildFragment([e], t, n), n && n.length && C(n).remove(), C.merge([], r.childNodes))
                    };
                    var Qt = C.fn.load;
                    C.fn.load = function(e, t, n) {
                        ...
                        var r, o, i, a = this,
                            s = e.indexOf(" ");
                        return 0 <= s && (r = C.trim(e.slice(s, e.length)), e = e.slice(0, s)), C.isFunction(t) ? (n = t, t = void 0) : t && "object" == (void 0 === t ? "undefined" : on(t)) && (i = "POST"), 0 < a.length && C.ajax({
                            url: e,
                            type: i,
                            dataType: "html",
                            data: t
                    ...
                    C.offset = {
                        setOffset: function(e, t, n) {
                            var r, o, i, a, s = C.css(e, "position"),
                                l = C(e),
                                c = {};
                            "static" === s && (e.style.position = "relative"), i = l.offset(), r = C.css(e, "top"), a = C.css(e, "left"), a = ("absolute" === s || "fixed" === s) && -1 < C.inArray("auto", [r, a]) ? (o = (s = l.position()).top, s.left) : (o = parseFloat(r) || 0, parseFloat(a) || 0), null != (t = C.isFunction(t) ? t.call(e, n, i) : t).top && (c.top = t.top - i.top + o), null != t.left && (c.left = t.left - i.left + a), "using" in t ? t.using.call(e, c) : l.css(c)
                        }
                    }, C.fn.extend({
                        offset: function(t) {
                            ...
                            var e, n = {
                                ...
                                r = this[0],
                                o = r && r.ownerDocument;
                            return o ? (e = o.documentElement, C.contains(e, r) ? (on(r.getBoundingClientRect) !== F && (n = r.getBoundingClientRect()), o = Jt(o), {
                        ...
                        position: function() {
                            if (this[0]) {
                                var e, t, n = {
                                    ...
                                    r = this[0];
                                return "fixed" === C.css(r, "position") ? t = r.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), (n = !C.nodeName(e[0], "html") ? e.offset() : n).top += C.css(e[0], "borderTopWidth", !0), n.left += C.css(e[0], "borderLeftWidth", !0)), {
                        ...
                        C.cssHooks[n] = Me(A.pixelPosition, function(e, t) {
                            return t ? (t = Ee(e, n), He.test(t) ? C(e).position()[n] + "px" : t) : void 0
                        })
                    }), C.each({
                        Height: "height",
                        Width: "width"
                        ...
                        C.each({
                            ...
                            C.fn[e] = function(e, t) {
                                ...
                                return U(this, function(e, t, n) {
                                    var r;
                                    return C.isWindow(e) ? e.document.documentElement["client" + i] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + i], r["scroll" + i], e.body["offset" + i], r["offset" + i], r["client" + i])) : void 0 === n ? C.css(e, t, o) : C.style(e, t, n, o)
                                }, a, n ? e : void 0, n, null)
                            }
                        })
                    }), C.fn.size = function() {
                        return this.length
                    }, C.fn.andSelf = C.fn.addBack, void 0 === (rn = function() {
                        return C
                    ...
                    }, (void 0 === e ? "undefined" : on(e)) === F && (h.jQuery = h.$ = C), C
            ...
            /*!*********************************************************************!*\
              ...
              \*********************************************************************/
                function(e, t, n) {
                n.r(t);
                var r = n( /*! ../node_modules/css-loader/dist/runtime/cssWithMappingToString.js */ "./node_modules/css-loader/dist/runtime/cssWithMappingToString.js"),
                    o = n.n(r),
                    i = n( /*! ../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js"),
                    r = n.n(i),
                    i = n( /*! ../node_modules/css-loader/dist/runtime/getUrl.js */ "./node_modules/css-loader/dist/runtime/getUrl.js"),
                    i = n.n(i),
                    n = n( /*! ./opacity.png */ "./src/opacity.png"),
                    o = r()(o()),
                    n = i()(n.default);
            ...
            /*!*******************************!*\
              ...
              \*******************************/
                function(e, t, n) {
                n.r(t);
                var r = n( /*! !../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js"),
                    o = n.n(r),
                    r = n( /*! !!../node_modules/css-loader/dist/cjs.js!./xncolorpicker.css */ "./node_modules/css-loader/dist/cjs.js!./src/xncolorpicker.css"),
                    n = {
                        insert: "head",
                        singleton: !1
                    };
            ...
            /*!****************************************************************************!*\
              ...
              \****************************************************************************/
                ...
                function l(e, t) {
                    for (var n = {}, r = [], o = 0; o < e.length; o++) {
                        ...
                        s = d(l), i = {
                            ...
                            media: i[2],
                            sourceMap: i[3]
                        }; - 1 !== s ? (c[s].references++, c[s].updater(i)) : c.push({
                            identifier: l,
                            updater: function(t, e) {
                                var n, r, o; {
                                    var i;
                                    o = e.singleton ? (i = g++, n = h = h || u(e), r = f.bind(null, n, i, !1), f.bind(null, n, i, !0)) : (n = u(e), r = function(e, t, n) {
                                        var r = n.css,
                                            o = n.media,
                                            n = n.sourceMap;
                ...
                var a, p = (a = [], function(e, t) {
                    return a[e] = t, a.filter(Boolean).join("\n")
                });

                function f(e, t, n, r) {
                    n = n ? "" : r.media ? "@media ".concat(r.media, " {").concat(r.css, "}") : r.css;
                    e.styleSheet ? e.styleSheet.cssText = p(t, n) : (r = document.createTextNode(n), (n = e.childNodes)[t] && e.removeChild(n[t]), n.length ? e.insertBefore(r, n[t]) : e.appendChild(r))
                }
                var h = null,
                    g = 0;
            ...
            /*!*************************!*\
              ...
              \*************************/
                function(e, t, n) {
                n.r(t), t.default = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAA5SURBVHgB7dOxDQAgDANBgxjE+0/lTYARXKSIIn9tXRNl3R+MJDkzbBQXMGAH8LgfQNLa5SgBR4IPUi8JxinXq5EAAAAASUVORK5CYII="
            }
        },
        r = {};
    ...
    l.n = function(e) {
        ...
        function() {
            ...
            var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                ...
                s = e(l( /*! ./jquery.min.js */ "./src/jquery.min.js")),
                r = e(l( /*! ./colorFormat.min.js */ "./src/colorFormat.min.js"));
            ...
            l( /*! ./xncolorpicker.css */ "./src/xncolorpicker.css");
            var o, t, i = (i = document.getElementsByTagName("script"))[i.length - 1],
                i = (i = document.querySelector ? i.src : i.getAttribute("src", 4)).substr(0, +i.lastIndexOf("/"));

            function a(e) {
                this.pos = {
                    left: 0,
                    top: 0
                }, this.moved = !1, this.id = this.getRandomString(), this.btns = {
                    cn: ["取消", "确定"],
                    en: ["Cancel", "OK"]
                }, this.colorTypeList = {
                    cn: {
                ...
                getRandomString: function(e) {
                    e = e || 8;
                    for (var t = "ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz", n = t.length, r = "", o = 0; o < e; o++) r += t.charAt(Math.floor(Math.random() * n));
                    return r
                },
                initCurrentColorBox: function() {
                    var t = this;
                    this.curcolordom = document.createElement("div"), this.curcolordom.classList.add("fcolorpicker-curbox"), this.curcolordom.style.background = this.option.color, this.$el.empty().append(this.curcolordom), t.init(), this.curcolordom.onclick = function(e) {
                        t.changeShow()
                    }, this.option.show && (0, s.default)(t.dom).show()
                },
                changeShow: function(e) {
                    (0, s.default)(this.dom) && "block" == (0, s.default)(this.dom).css("display") || e ? this.option.alwaysShow || ((0, s.default)(this.dom).empty(), (0, s.default)(this.dom).hide(), this.moved = !1) : (this.init(), (0, s.default)(this.dom).show())
                },
                init: function() {
                    this.initDom(), this.initColorFormat(), this.option.showPalette ? (this.initPalette(), this.initColorBand(), this.initOpacity()) : this.dom.querySelector(".color-palette").style.display = "none", this.setPrevColors(), this.getHistoryColors(), this.setPosition(), this.addPosEvent(), this.changeColorFormatType(), (0, s.default)(this.dom).hide()
                },
                rendGradientDom: function() {},
                initDom: function() {
                    var e = !0,
                        t = document.body.querySelector(".fcolorpicker#" + this.id);
                    t || ((t = document.createElement("div")).classList.add("fcolorpicker"), this.option.canMove && t.classList.add("canmove"), t.id = this.id, e = !1);
                    ...
                    t.innerHTML = i, this.dom = t, document.body.appendChild(this.dom), this.canvasSize = {
                        width: 212,
                        height: 129
                    }, this.lightbar = this.dom.querySelector(".lightbar"), this.huebar = this.dom.querySelector(".huebar"), this.opacitybar = this.dom.querySelector(".opacitybar"), this.option.showprecolor || (0, s.default)(this.dom).find(".color-recommend").hide(), this.option.showhistorycolor || (0, s.default)(this.dom).find(".color-latest").hide(), this.option.colorTypeOption.length < 2 && (0, s.default)(this.dom).find(".color-type").remove(), this.setPosition(), e || this.addEvent(), this.addBlurEvent()
                },
                ...
                moveDom: function(e, t) {
                    var n;
                    this.dom && (this.moved = !0, n = t.clientX - e.x + this.pos.left, e = t.clientY - e.y + this.pos.top, this.dom.style.top = e + "px", this.dom.style.left = n + "px")
                },
                setPosition: function() {
                    var e, t, n, r, o, i, a;
                    this.dom && !this.moved && (e = document.documentElement.clientWidth, t = document.documentElement.clientHeight, r = (n = this.$el[0].querySelector("div")).getBoundingClientRect().top, a = n.getBoundingClientRect().left, o = (0, s.default)(this.dom).outerWidth(), i = (0, s.default)(this.dom).outerHeight(), a = e - a <= o ? a - o - 10 : a + 10 + n.offsetWidth, (r = t - r < i ? r - i - n.offsetHeight : r) < 10 && (r = 10), this.dom.style.top = r + "px", this.dom.style.left = a + "px", this.pos = {
                        left: a,
                        top: r
                    })
                },
                addHistoryColors: function() {
                    for (var e = this.color[this.currentColorFormat], t = 0; t < this.hiscolors.length; t++)
                        if ((0, r.default)({
                                color: this.hiscolors[t],
                                format: this.currentColorFormat
                            }).complete == e) {
                            this.hiscolors.splice(t, 1);
                            break
                        }
                    this.hiscolors.unshift(e), o.localStorage.setItem("fcolorpicker", this.hiscolors.join(";")), this.rendHisColors(), this.setPosition()
                },
                getHistoryColors: function() {
                    var e = o.localStorage.getItem("fcolorpicker");
                    this.hiscolors = (e || "").split(";"), this.rendHisColors()
                },
                clearHistoryColors: function() {
                    this.hiscolors = [], o.localStorage.setItem("fcolorpicker", this.hiscolors.join(";")), this.rendHisColors(), this.setPosition()
                },
                rendHisColors: function() {
                    if (this.option.showhistorycolor) {
                        (0, s.default)(this.dom).find(".color-latest").empty();
                        for (var e, t = 0; t < (this.option.historycolornum < 0 ? this.hiscolors.length : this.option.historycolornum); t++) this.hiscolors[t] && "" != this.hiscolors[t] && (e = '\n                    <div class="color-item" data-color="' + this.hiscolors[t] + '">\n                    <span style="background:' + this.hiscolors[t] + '"></span>\n</div>\n                ', (0, s.default)(this.dom).find(".color-latest").append(e))
                    }
                },
                setPrevColors: function() {
                    if (this.option.showprecolor)
                        for (var e = 0; e < this.option.prevcolors.length; e++) {
                            ...
                            (0, s.default)(this.dom).find(".color-recommend").append(t)
                        }
                },
                addBlurEvent: function() {
                    var t = this;
                    this.dom.querySelector("input").onblur = function(e) {
                        t.initColorFormat(t.dom.querySelector(".current-color-value input").value), t.fillOpacity(), t.fillPalette(), t.addHistoryColors()
                    }
                },
                cancleFun: function() {
                    ...
                    "single" == this.currentColorType ? (e.color = this.color, this.lastColor = this.color.rgba) : (e.color = this.gradientColor, this.lastColor = this.gradientColor.str), this.changeCurColorDom(), this.option.onCancel(e), this.changeShow(!0)
                },
                getCurrentColor: function(e) {
                    this.initColorFormat(this.dom.querySelector(".current-color-value input").value, !0), this.addHistoryColors();
                    var t = {
                        colorType: this.currentColorType
                    };
                    return "single" == this.currentColorType ? (t.color = this.color, e && (this.lastColor = this.color.rgba)) : (t.color = this.gradientColor, e && (this.lastColor = this.gradientColor.str)), this.changeCurColorDom(), t
                },
                addEvent: function() {
                    var r = this,
                        o = null,
                    ...
                    i.dom.addEventListener("mousedown", function(e) {
                        var t, n = (0, s.default)(e.target);
                        o = null, 0 < n.parents(".lightness").length && (o = "lightness"), 0 < n.parents(".hue").length && (o = "hue", t = 100 * e.offsetY / i.canvasSize.height, i.huebar.style.top = t.toFixed(2) + "%", a.bartop = parseFloat(i.huebar.style.top)), 0 < n.parents(".opacity").length && (o = "opacity", t = 100 * e.offsetY / i.canvasSize.height, i.opacitybar.style.top = t.toFixed(2) + "%", a.bartop = parseFloat(i.opacitybar.style.top)), a.x = e.clientX, a.y = e.clientY, o && i.changeColor(o, e, null), (n = n.parents(".gradient-item")[0] ? n.parents(".gradient-item") : n).hasClass("gradient-item") && (a.isGradientBar = !0, r.gradientIndex = n.index(), r.updateGradientBar(), r.setCurrentGradientColor(), a.$ele = n), n.hasClass("add-gradient") && (r.gradientColor.arry.colors.push({
                            per: 100,
                            color: "#ffffff"
                        }), r.gradientColor = r.revertGradientToString(r.gradientColor.arry), r.gradientIndex = r.gradientColor.arry.colors.length - 1, r.rendInputValue(), r.rendGradientColors(), r.updateGradientBar()), n.hasClass("angle-bar") && (a.isGradientBar = !1, a.isAngleBar = !0), n[0] == r.dom && r.option.canMove ? a.isMove = !0 : a.isMove = !1
                    }), document.addEventListener("mousemove", function(e) {
                        var t;
                        o ? i.changeColor(o, e, a) : a.isGradientBar ? (t = (100 * (e.clientX - (0, s.default)(r.dom).find(".gradient-colors")[0].getBoundingClientRect().left) / (0, s.default)(r.dom).find(".gradient-colors")[0].getBoundingClientRect().width).toFixed(1), r.gradientColor.arry.colors.length < 3 ? (t = 100 < t ? 100 : t) < 0 && (t = 0) : -5 <= (t = 100 < t && t <= 105 ? 100 : t) && t < 0 && (t = 0), r.gradientColor.arry.colors[r.gradientIndex].per = t, a.$ele.css({
                            left: t + "%"
                        }), r.updateGradientColors(!0), r.changeCurColorDom(), t < -5 || 105 < t ? a.$ele.addClass("deleting-item") : a.$ele.removeClass("deleting-item")) : a.isAngleBar && (360 < (t = (t = (360 * (e.clientX - (0, s.default)(r.dom).find(".gradient-angle")[0].getBoundingClientRect().left) / (0, s.default)(r.dom).find(".gradient-angle")[0].getBoundingClientRect().width).toFixed(1)) < 0 ? 0 : t) && (t = 360), r.gradientColor.arry.angle = t, r.updateAngleBar(), r.updateGradientColors(), r.changeCurColorDom()), a.isMove && r.moveDom(a, e)
                    }), document.addEventListener("mouseup", function(e) {
                        var t;
                        a.isGradientBar && (t = (100 * (e.clientX - (0, s.default)(r.dom).find(".gradient-colors")[0].getBoundingClientRect().left) / (0, s.default)(r.dom).find(".gradient-colors")[0].getBoundingClientRect().width).toFixed(1), 2 < r.gradientColor.arry.colors.length && (105 < t || t < -5) && (r.gradientColor.arry.colors.splice(r.gradientIndex, 1), a.$ele.remove(), r.updateGradientBar(), r.gradientColor = r.revertGradientToString(r.gradientColor.arry), r.rendInputValue()), t = i.getCurrentColor(r.option.autoConfirm), i.option.onChange(t), r.option.autoConfirm && r.option.onConfirm(t)), (o || a.isAngleBar) && (t = i.getCurrentColor(r.option.autoConfirm), i.option.onChange(t), r.option.autoConfirm && r.option.onConfirm(t)), o = null, a.isGradientBar = !1, a.isAngleBar = !1, a.isMove && (t = e.clientX - a.x + r.pos.left, e = e.clientY - a.y + r.pos.top, r.pos.left = t, r.pos.top = e), a.isMove = !1
                    }), this.dom.addEventListener("click", function(e) {
                        e.stopPropagation();
                        var t, e = (0, s.default)(e.target);
                        if (e.hasClass("color-item")) {
                            i.getColorFormat(e.attr("data-color")), i.fillOpacity(), i.fillPalette(), i.addHistoryColors(), "single" != r.currentColorType && (r.updateGradientColors(), r.changeCurColorDom());
                            var n = i.getCurrentColor(r.option.autoConfirm);
                            return i.option.onChange(n), void(r.option.autoConfirm && r.option.onConfirm(n))
                        }
                        if (e.hasClass("cancel-color") && r.cancleFun(), e.hasClass("confirm-color")) {
                            n = i.getCurrentColor(!0);
                            return i.option.onConfirm(n), void i.changeShow(!0)
                        }(e = e.hasClass("color-slidedown-curbox") ? e.parent() : e).hasClass("color-slidedown") && (e.hasClass("down") ? e.removeClass("down") : e.addClass("down")), e.hasClass("color-type-item") && (e.hasClass("on") ? e.parents(".color-slidedown").removeClass("down") : (t = e.attr("data-type"), r.currentColorType = t, r.changeColorType())), e.hasClass("color-format-type-item") && (e.hasClass("on") ? e.parents(".color-slidedown").removeClass("down") : (t = e.attr("data-type"), r.currentColorFormat = t, r.changeColorFormatType()))
                    });

                    function e(e) {
                        e.stopPropagation(), i.dom && e.target != i.dom && (0, s.default)(e.target).parents(".fcolorpicker")[0] != i.dom && (0, s.default)(e.target)[0] != i.curcolordom && "block" == (0, s.default)(i.dom).css("display") && i.cancleFun(), (0, s.default)(r.dom).find(".color-slidedown").not((0, s.default)(e.target).parents(".color-slidedown")[0]).removeClass("down")
                    }
                ...
                changeColor: function(e, t, n) {
                    if (e) {
                        ...
                        if (n) {
                            ...
                            if (99.9 < i && "lightness" != e) return;
                            i < 0 && (i = 0)
                        } else i = (100 * t.offsetY / this.canvasSize.height).toFixed(2);
                        switch (e) {
                            case "hue":
                                this.huebar.style.top = i + "%", c = "hsla(" + 360 * i / 100 + "," + this.color.hslav[1] + "%," + this.color.hslav[2] + "%," + this.color.hslav[3] + ")";
                                break;
                            case "lightness":
                                r = t.clientX - this.dom.querySelector(".lightness").getBoundingClientRect().left;
                                (o = t.clientY - this.dom.querySelector(".lightness").getBoundingClientRect().top) < 0 && (o = 0), (r = r < 0 ? 0 : r) > this.dom.querySelector(".lightness canvas").getBoundingClientRect().width && (r = this.dom.querySelector(".lightness canvas").getBoundingClientRect().width), o > this.dom.querySelector(".lightness canvas").getBoundingClientRect().height && (o = this.dom.querySelector(".lightness canvas").getBoundingClientRect().height);
                                ...
                                this.lightbar.style.top = o + "px", this.lightbar.style.left = r + "px";
                                break;
                            case "opacity":
                                i = 99.2 < i ? 100 : i, this.opacitybar.style.top = i + "%", c = "rgba(" + this.color.rgbav[0] + "," + this.color.rgbav[1] + "," + this.color.rgbav[2] + "," + ((100 - i) / 100).toFixed(2) + ")"
                        }
                        this.getColorFormat(c), "hue" == e && (this.fillOpacity(), this.fillPalette()), this.setPosition(), "single" != this.currentColorType && this.updateGradientColors(), this.changeCurColorDom()
                    }
                },
                HSBToRGB: function(e) {
                    var t = {},
                        ...
                        r = 255 * e.s / 100,
                        o = 255 * e.b / 100;
                    return 0 == r ? t.r = t.g = t.b = o : (o = n % 60 * ((e = o) - (r = (255 - r) * o / 255)) / 60, (n = 360 == n ? 0 : n) < 60 ? (t.r = e, t.b = r, t.g = r + o) : n < 120 ? (t.g = e, t.b = r, t.r = e - o) : n < 180 ? (t.g = e, t.r = r, t.b = r + o) : n < 240 ? (t.b = e, t.r = r, t.g = e - o) : n < 300 ? (t.b = e, t.g = r, t.r = r + o) : n < 360 ? (t.r = e, t.g = r, t.b = e - o) : (t.r = 0, t.g = 0, t.b = 0)), {
                        r: Math.round(t.r),
                        g: Math.round(t.g),
                        b: Math.round(t.b)
                    }
                ...
                updateGradientColors: function(e) {
                    this.gradientColor.arry.colors[this.gradientIndex].color = this.color.rgba, this.updateGradientBar(), this.updateGradientColorItem(this.gradientIndex, this.color.rgba), this.gradientColor = this.revertGradientToString(this.gradientColor.arry), this.rendInputValue(), e || this.rendGradientColors()
                },
                rendInputValue: function() {
                    "single" != this.currentColorType ? (this.dom.querySelector(".current-color").style.background = this.gradientColor.str, this.dom.querySelector(".current-color-value input").value = this.gradientColor.str) : (this.dom.querySelector(".current-color").style.background = this.color[this.currentColorFormat], this.dom.querySelector(".current-color-value input").value = this.color[this.currentColorFormat])
                },
                initColorBand: function() {
                    var e = document.createElement("canvas");
                    this.ctxhue = e.getContext("2d"), e.width = 10, e.height = this.canvasSize.height, this.dom.querySelector(".color-palette .hue").appendChild(e), this.ctxhue.rect(0, 0, 10, this.canvasSize.height);
                    e = this.ctxhue.createLinearGradient(0, 0, 0, this.canvasSize.height);
                    e.addColorStop(0, "rgba(255, 0, 0, 1)"), e.addColorStop(.17, "rgba(255, 255, 0, 1)"), e.addColorStop(.34, "rgba(0, 255, 0, 1)"), e.addColorStop(.51, "rgba(0, 255, 255, 1)"), e.addColorStop(.68, "rgba(0, 0, 255, 1)"), e.addColorStop(.85, "rgba(255, 0, 255, 1)"), e.addColorStop(1, "rgba(255, 0, 0, 1)"), this.ctxhue.fillStyle = e, this.ctxhue.fill()
                },
                initOpacity: function() {
                    var e = document.createElement("canvas");
                    this.ctxopacity = e.getContext("2d"), e.width = 10, e.height = this.canvasSize.height, this.dom.querySelector(".color-palette .opacity").appendChild(e), this.fillOpacity()
                },
                fillOpacity: function() {
                    var e;
                    this.ctxopacity && (this.ctxopacity.clearRect(0, 0, 10, this.canvasSize.height), (e = this.ctxlightness.createLinearGradient(0, 0, 10, this.canvasSize.height)).addColorStop(0, "rgba(" + this.color.rgbav[0] + "," + this.color.rgbav[1] + "," + this.color.rgbav[2] + ",1)"), e.addColorStop(1, "rgba(" + this.color.rgbav[0] + "," + this.color.rgbav[1] + "," + this.color.rgbav[2] + ",0)"), this.ctxopacity.fillStyle = e, this.ctxopacity.fillRect(0, 0, 10, this.canvasSize.height))
                },
                initPalette: function() {
                    this.canvas = document.createElement("canvas"), this.ctxlightness = this.canvas.getContext("2d"), this.canvas.width = this.canvasSize.width, this.canvas.height = this.canvasSize.height, this.dom.querySelector(".color-palette .lightness").appendChild(this.canvas), this.fillPalette()
                },
                fillPalette: function() {
                    var e, t, n;
                    this.ctxlightness && (this.ctxlightness.fillStyle = "hsla(" + this.color.hslav[0] + ",100%,50%,1)", e = this.canvasSize.width, t = this.canvasSize.height, this.ctxlightness.fillRect(0, 0, e, t), (n = this.ctxlightness.createLinearGradient(0, 0, e, 0)).addColorStop(0, "rgba(255,255,255,1)"), n.addColorStop(1, "rgba(255,255,255,0)"), this.ctxlightness.fillStyle = n, this.ctxlightness.fillRect(0, 0, e, t), (n = this.ctxlightness.createLinearGradient(0, 0, 0, t)).addColorStop(0, "rgba(0,0,0,0)"), n.addColorStop(1, "rgba(0,0,0,1)"), this.ctxlightness.fillStyle = n, this.ctxlightness.fillRect(0, 0, e, t), this.updatelightbar())
                },
                updatelightbar: function() {
                    ...
                    this.lightbar.style.top = e + "px", this.lightbar.style.left = t + "px"
                },
                RGBToHSB: function(e) {
                    var t = {
                            h: 0,
                        ...
                        o = r - n;
                    return t.b = r, t.s = 0 != r ? 255 * o / r : 0, 0 != t.s ? e.r == r ? t.h = (e.g - e.b) / o : e.g == r ? t.h = 2 + (e.b - e.r) / o : t.h = 4 + (e.r - e.g) / o : t.h = -1, r == n && (t.h = 0), t.h *= 60, t.h < 0 && (t.h += 360), t.s *= 100 / 255, t.b *= 100 / 255, t
                },
                setColor: function(e) {
                    this.option.color = e, this.getColorFormat(e)
                },
                getColor: function(e) {
                    return this.color
                },
                initColorFormat: function(e, t) {
                    "object" == (void 0 === (e = e || this.lastColor) ? "undefined" : n(e)) ? (this.gradientColor = this.revertGradientToString(e), -1 < this.gradientColor.str.indexOf("linear-gradient") ? this.currentColorType = "linear-gradient" : this.currentColorType = "radial-gradient") : -1 < e.toLowerCase().indexOf("linear-gradient") || -1 < e.toLowerCase().indexOf("radial-gradient") ? (this.gradientColor = this.revertGradientToArray(e), -1 < this.gradientColor.str.indexOf("linear-gradient") ? this.currentColorType = "linear-gradient" : this.currentColorType = "radial-gradient") : (this.getColorFormat(e || "#000"), this.currentColorType = "single"), t || (this.changeColorType(!0), "single" != this.currentColorType && (this.setCurrentGradientColor(), this.updateAngleBar(), this.updateGradientColors(), this.rendGradientColors()))
                },
                ...
                updateAngleBar: function() {
                    (0, s.default)(this.dom).find(".current-angle span").html(this.gradientColor.arry.angle + "°"), (0, s.default)(this.dom).find(".current-angle .angle-bar").css("left", this.gradientColor.arry.angle / 3.6 + "%")
                },
                updateGradientColorItem: function(e, t) {
                    (0, s.default)(this.dom).find(".gradient-item").eq(e).find(".color").css("background", t)
                },
                updateGradientBar: function() {
                    var e = this.revertGradientToString(this.gradientColor.arry, !0);
                    (0, s.default)(this.dom).find(".gradient-bar span").css("background", e.str), (0, s.default)(this.dom).find(".gradient-item").removeClass("on").eq(this.gradientIndex).addClass("on")
                },
                rendGradientColors: function() {
                    for (var e = "", t = 0; t < this.gradientColor.arry.colors.length; t++) e += '<div class="gradient-item iconfontcolorpicker iconcolorpicker1" style="left:' + this.gradientColor.arry.colors[t].per + '%">\n                            <div class="color" style="background:' + this.gradientColor.arry.colors[t].color + '"></div>\n                        </div>';
                    (0, s.default)(this.dom).find(".gradient-colors").empty().append(e), (0, s.default)(this.dom).find(".gradient-item").removeClass("on").eq(this.gradientIndex).addClass("on")
                },
                setColorTypeDom: function() {
                    (0, s.default)(this.dom).find(".color-type")[0] && ((0, s.default)(this.dom).find(".color-type li").removeClass("on"), (0, s.default)(this.dom).find(".color-type-item[data-type=" + this.currentColorType + "]").addClass("on"), (0, s.default)(this.dom).find(".color-type").removeClass("down"), (0, s.default)(this.dom).find(".color-type .color-slidedown-curbox")[0].innerHTML = (0, s.default)(this.dom).find(".color-type-item[data-type=" + this.currentColorType + "]")[0].innerHTML)
                },
                changeColorFormatType: function() {
                    (0, s.default)(this.dom).find(".color-format-type li").removeClass("on"), (0, s.default)(this.dom).find(".color-format-type-item[data-type=" + this.currentColorFormat + "]").addClass("on"), (0, s.default)(this.dom).find(".color-format-type").removeClass("down"), (0, s.default)(this.dom).find(".color-format-type .color-slidedown-curbox")[0].innerHTML = (0, s.default)(this.dom).find(".color-format-type-item[data-type=" + this.currentColorFormat + "]")[0].innerHTML;
                    var e = this.getCurrentColor(this.option.autoConfirm);
                    this.rendInputValue(), this.option.onChange(e), this.option.autoConfirm && this.option.onConfirm(e)
                },
                changeColorType: function(e) {
                    this.gradientIndex = 0;
                    var t = this.option.colorTypeOption.indexOf(this.currentColorType) < 0;
                    t && (this.currentColorType = this.option.colorTypeOption[0]), "single" == this.currentColorType ? (e && !t || this.getColorFormat(this.gradientColor ? this.gradientColor.arry.colors[0].color : "#ffffff"), (0, s.default)(this.dom).find(".color-gradient").hide()) : (e && !t || this.gradientColor || (this.gradientColor = {
                    ...
                    })), this.gradientColor.arry.type != this.currentColorType && (this.gradientColor.arry.type = this.currentColorType, this.gradientColor = this.revertGradientToString(this.gradientColor.arry)), (0, s.default)(this.dom).find(".color-gradient").show(), this.rendGradientColors(), this.updateGradientBar(), this.updateAngleBar(), this.changeCurColorDom(), "linear-gradient" == this.currentColorType ? (0, s.default)(this.dom).find(".gradient-angle").show() : (0, s.default)(this.dom).find(".gradient-angle").hide()), this.setColorTypeDom(), this.rendInputValue(), this.setPosition()
                },
                getColorFormat: function(e) {
                    this.color = this.getColorFormatFunc(e), this.color.rgbav = this.color.rgba.slice(5, this.color.rgba.indexOf(")")).split(","), this.color.hslav = this.color.hsla.slice(5, this.color.hsla.indexOf(")")).split(",").map(function(e) {
                        return -1 < e.indexOf("%") ? e.slice(0, e.indexOf("%")) : e
                    }), this.dom && ("single" == this.currentColorType && (this.changeCurColorDom(), this.dom.querySelector(".current-color").style.background = this.color.rgba, this.dom.querySelector(".current-color-value input").value = this.color[this.currentColorFormat]), this.setBarPos())
                },
                ...
                getColorFormatFunc: function(e) {
                    e.indexOf("rgb") < 0 && e.indexOf("#") < 0 && e.indexOf("hsl") < 0 && (e = "rgba(0,0,0,0)");
                    e = {
                        rgba: (0, r.default)({
                            color: e,
                            format: "rgba"
                ...
                setBarPos: function() {
                    this.opacitybar.style.top = 100 * (1 - this.color.rgbav[3]) + "%", 0 != parseFloat(this.color.hslav[1]) && (this.huebar.style.top = 100 * this.color.hslav[0] / 360 + "%")
                },
                replace: function() {
                ...
                revertGradientToArray: function(e) {
                    ...
                    e = this.replace(e, /(rgba\(.*?\))/gi, function(e) {
                        ...
                        return t.getColorFormatFunc(e).hex
                    })).toLowerCase().indexOf("radial-gradient") && (n = "radial-gradient"), -1 < e.toLowerCase().indexOf("linear-gradient") && (n = "linear-gradient");
                ...
                revertGradientToString: function(e, t) {
                    ...
                    for (var r = 0; r < e.colors.length; r++) {
                        ...
                        n += (e.colors[r].color = o) + " " + parseFloat(e.colors[r].per).toFixed(1), "" != e.colors[r].per && (n += "%"), r < e.colors.length - 1 && (n += ",")
                    }
                    return {
                        str: n += ")",
                        arry: e
                ...
                destroy: function() {
                    (0, s.default)(this.dom).remove(), this.removeMouseDownEvent(), this.curcolordom.onclick = null
                }
            }, o.XNColorPicker = a
        }()
}();
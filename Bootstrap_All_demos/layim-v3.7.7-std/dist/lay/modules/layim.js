    ...
    function(i) {
     ...
     layui.data.date = function(i) {
      ...
      return a.getFullYear() + "-" + g(a.getMonth() + 1) + "-" + g(a.getDate()) + " " + g(a.getHours()) + ":" + g(a.getMinutes()) + ":" + g(a.getSeconds())
         ...
         //转换内容
         layui.data.content = function(i) { debugger;
             if ((/weui-/.test(i))){ //自定义消息模板-weui图文组合列表
                return i
             }else if ((/layui-/.test(i))){ //自定义消息模板-layui图文组合列表
                 return i
             }else{ // 系统消息模板
                    //支持的html标签
                 var a = function(i) {
                     return new RegExp("\\n*\\[" + (i || "") + "(a|img|code|pre|div|span|p|table|thead|th|tbody|tr|td|ul|li|ol|li|dl|dt|dd|h1|h2|h3|h4|h5)([\\s\\S]*?)\\]\\n*", "g")
                 };

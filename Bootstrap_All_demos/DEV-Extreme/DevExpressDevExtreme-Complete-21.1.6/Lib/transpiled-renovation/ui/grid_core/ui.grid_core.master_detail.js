    ...
    controllers: {
      ...
      resizing: {
        ...
        _updateFixedMasterDetailGrids: function _updateFixedMasterDetailGrids(masterDataGrid, masterRowIndex, $detailElement) {
          ...
          var rowsNotEqual = ($rows === null || $rows === void 0 ? void 0 : $rows.length) === 2 && $rows.eq(0).height() !== $rows.eq(1).height();
          var tablesNotEqual = ($tables === null || $tables === void 0 ? void 0 : $tables.length) === 2 && $tables.eq(0).height() !== $tables.eq(1).height();

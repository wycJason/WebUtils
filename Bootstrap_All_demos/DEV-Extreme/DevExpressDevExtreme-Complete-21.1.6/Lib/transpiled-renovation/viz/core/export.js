...
exports.DEBUG_set_ExportMenu = exports.DEBUG_set_combineMarkups = exports.plugin = exports.ExportMenu = exports.combineMarkups = exports.exportWidgets = exports.getMarkup = exports.exportFromMarkup = void 0;
...
function setPrint(imageSrc, options) {
  return function () {
    ...
    window.document.body.appendChild(img); ///#DEBUG
    ...
    var removeFrame = function removeFrame() {
      ...
      options.__test && options.__test.deferred.resolve(origImageSrc); ///#ENDDEBUG
    };

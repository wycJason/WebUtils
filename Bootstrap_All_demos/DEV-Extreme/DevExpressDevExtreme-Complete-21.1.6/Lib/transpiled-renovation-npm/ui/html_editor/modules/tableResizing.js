...
var TableResizingModule = /*#__PURE__*/function (_BaseModule) {
  ...
  _proto._fixTablesWidths = function _fixTablesWidths($tables) {
    ...
    (0, _iterator.each)($tables, function (index, table) {
      ...
      if ($columnElements.eq(0).attr('width')) {
        ...
        var tableWidth = (_this4$_tableLastWidt = _this4._tableLastWidth(frame)) !== null && _this4$_tableLastWidt !== void 0 ? _this4$_tableLastWidt : $table.outerWidth();
  ...
  _proto._getLineElements = function _getLineElements($table, index, direction) {
    var result;
  ...
  _proto._setLineElementsAttrValue = function _setLineElementsAttrValue($lineElements, property, value) {
  ...
  _proto.option = function option(_option, value) {
    ...
    } else if (_option === 'minColumnWidth' || _option === 'minRowHeight') {

...
function renderFieldItemTo(_ref) {
  ...
  //
  $container.addClass(containerCssClass).addClass((0, _type.isDefined)(item.col) ? 'dx-col-' + item.col : ''); // TODO: this is a part of Form markup settings, move it to form.js

    ...
    switch (culture) {
        ...
        case "cn":
            localization =
            {
                ...
                groupsheaderstring: "拖动一列并放在这里按该列分组",
                sortascendingstring: "升序排序",
                sortdescendingstring: "降序排序",
                sortremovestring: "删除排序",
                groupbystring: "将该列设置为分组列",
                groupremovestring: "从分组列中删除该列",
                filterclearstring: "清除",
                filterstring: "过滤器",
                filtershowrowstring: "显示行所在:",
                ...
                filterstringcomparisonoperators: ['empty', 'not empty', 'enthalten', 'enthalten(match case)',
                    '不包含', '不包含（匹配的情况下）', '开始于', '开始于（匹配的情况下）',
                    '结束于', '结束于（匹配的情况下）', '等于', '等于（匹配的情况下）', '空', '非空'],

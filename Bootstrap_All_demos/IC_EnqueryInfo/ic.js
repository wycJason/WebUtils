function ICInjectJS(path, tbc) {
    if (document.getElementById("ERP_ICEnquery")) {
        return false;
    }

    /* var jq = document.createElement("script");
     jq.type = "text/javascript";
     jq.src = "https://cdn.bootcss.com/jquery/1.11.3/jquery.min.js";
     document.body.appendChild(jq);

     var bs = document.createElement("script");
     bs.type = "text/javascript";
     bs.src = "https://cdn.bootcss.com/bootstrap/3.0.0/js/bootstrap.min.js";
    ...
    /*__________________________________________________________________jquery v1.11.3______________________________________________________________________________________*/
    ...
    /*__________________________________________________________________jQueryUI-v1.11.4-2015-03-11______________________________________________________________________________________*/
    ...
    /*__________________________________________________________________bootstrap v3.0.0 ______________________________________________________________________________________*/
    ...
    //style样式
    function myCustomeStyle() {
        var myStyleFile = '.ic-btn {display: inline-block;padding: 6px 12px;margin-bottom: 0;font-size: 14px;font-weight: normal;line-height: 1.428571429;text-align: center;white-space: nowrap;vertical-align: middle;cursor: pointer;border: 1px solid transparent;border-radius: 4px; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; -o-user-select: none;user-select: none;}.ic-btn-default {color: #333333;background-color: #ffffff;border-color: #cccccc;}.ic-btn-info {color: #ffffff;background-color: #5bc0de;border-color: #46b8da;}.ic-btn-default:hover{color:#333;background-color:#e6e6e6;border-color:#adadad}.ic-btn-info:hover{color:#fff;background-color:#31b0d5;border-color:#269abc}.form-inline .form-group {display: inline-block;margin-bottom: 0;vertical-align: middle;}.form-inline .form-control {display: inline-block;}.form-inline .radio,.form-inline .checkbox {display: inline-block;padding-left: 0;margin-top: 0;margin-bottom: 0;}.form-inline .radio input[type="radio"],.form-inline .checkbox input[type="checkbox"] {float: none;margin-left: 0;}.form-control:-moz-placeholder {color: #999999;}.form-control::-moz-placeholder {color: #999999;}.form-control:-ms-input-placeholder {color: #999999;}.form-control::-webkit-input-placeholder {color: #999999;}.form-control {display: block;width: 100%;height: 34px;padding: 6px 12px;font-size: 14px;line-height: 1.428571429;color: #555555;vertical-align: middle;background-color: #ffffff;border: 1px solid #cccccc;border-radius: 4px; -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075); -webkit-transition: border-color ease-in-out 0.15s, box-shadow ease-in-out 0.15s;transition: border-color ease-in-out 0.15s, box-shadow ease-in-out 0.15s;}.form-control:focus {border-color: #66afe9;outline: 0; -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px rgba(102, 175, 233, 0.6);box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px rgba(102, 175, 233, 0.6);}.form-control[disabled],.form-control[readonly],fieldset[disabled] .form-control {cursor: not-allowed;background-color: #eeeeee;}textarea.form-control {height: auto;}.close {float: right;font-size: 21px;font-weight: bold;line-height: 1;color: #000000;text-shadow: 0 1px 0 #ffffff;opacity: 0.2;filter: alpha(opacity=20);}.close:hover,.close:focus {color: #000000;text-decoration: none;cursor: pointer;opacity: 0.5;filter: alpha(opacity=50);}button.close {padding: 0;cursor: pointer;background: transparent;border: 0; -webkit-appearance: none;}.modal-open {overflow: hidden;}body.modal-open,.modal-open .navbar-fixed-top,.modal-open .navbar-fixed-bottom {margin-right: 15px;}.modal {position: fixed;top: 0;right: 0;bottom: 0;left: 0;z-index: 1040;display: none;overflow: auto;overflow-y: scroll;}.modal.fade .modal-dialog { -webkit-transform: translate(0, -25%); -ms-transform: translate(0, -25%);transform: translate(0, -25%); -webkit-transition: -webkit-transform 0.3s ease-out; -moz-transition: -moz-transform 0.3s ease-out; -o-transition: -o-transform 0.3s ease-out;transition: transform 0.3s ease-out;}.modal.in .modal-dialog { -webkit-transform: translate(0, 0); -ms-transform: translate(0, 0);transform: translate(0, 0);}.modal-dialog {z-index: 1050;width: auto;padding: 10px;margin-right: auto;margin-left: auto;}.modal-content {position: relative;background-color: #ffffff;border: 1px solid #999999;border: 1px solid rgba(0, 0, 0, 0.2);border-radius: 6px;outline: none; -webkit-box-shadow: 0 3px 9px rgba(0, 0, 0, 0.5);box-shadow: 0 3px 9px rgba(0, 0, 0, 0.5);background-clip: padding-box;}.modal-backdrop {position: fixed;top: 0;right: 0;bottom: 0;left: 0;z-index: 1030;background-color: #000000;}.modal-backdrop.fade {opacity: 0;filter: alpha(opacity=0);}.modal-backdrop.in {opacity: 0.5;filter: alpha(opacity=50);}.modal-header {min-height: 16.428571429px;padding: 15px;border-bottom: 1px solid #e5e5e5;}.modal-header .close {margin-top: -2px;}.modal-title {margin: 0;line-height: 1.428571429;}.modal-body {position: relative;padding: 20px;}.modal-footer {padding: 19px 20px 20px;margin-top: 15px;text-align: right;border-top: 1px solid #e5e5e5;}.modal-footer:before,.modal-footer:after {display: table;content: " ";}.modal-footer:after {clear: both;}.modal-footer:before,.modal-footer:after {display: table;content: " ";}.modal-footer:after {clear: both;}.modal-footer .btn + .btn {margin-bottom: 0;margin-left: 5px;}.modal-footer .btn-group .btn + .btn {margin-left: -1px;}.modal-footer .btn-block + .btn-block {margin-left: 0;}.modal-dialog {right: auto;left: 50%;width: 600px;padding-top: 30px;padding-bottom: 30px;}.modal-content { -webkit-box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5);box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5);}.ICenqueryTel{margin-bottom:10px;}.ICenqueryTelWrap{margin-bottom:20px;}.ICenqueryTypeWrap{margin-bottom:10px;}.ICenqueryType{margin-bottom:20px;}.customEnquryInfo{margin-bottom: 2px;margin-right: 5px;float: left;}';
        if (document.all) { // document.createStyleSheet(url)
            window.style = myStyleFile;
    ...
    $(document.body).append('<div class="modal" id="ERP_ICEnquery" data-backdrop="static" data-keyboard="false" style="z-index:3000">\
        <div class="modal-dialog" style="width:702px">\
            <div class="modal-content">\
                ...
                <span style="font-size:14px;font-weight:bold;" id="cardName"></span>\
                </div>\
            <div class="modal-body" style="padding-bottom: 0;padding-top: 0;">\
                <form id="ICenqueryInfo">\
                 <div class="ICenqueryTelWrap">\
                    <div class="form-inline ICenqueryTel">\
                        <input type="hidden" name="Contacts">\
                        <input type="hidden" name="Supplier"/>\
                    </div>\
                    <div class="form-inline ICenqueryTel">\
                        <span style="display: inline-block;width:70px;">联系电话</span>\
                        <input type="text" readonly name="Tel1" value="" class="form-control" style="width:250px;height: 20px" />\
                    </div>\
                    <div class="form-inline ICenqueryTel">\
                        <span style="display: inline-block;width:70px;">供应商电话</span>\
                        <textarea readonly id="IC_TelB" style="width: 510px;height: 60px;" class="form-control"></textarea>\
                    </div>\
                    <div class="form-inline ICenqueryTel">\
                        <span>地址</span>\
                        <input type="text" readonly name="Address" value="" class="form-control" style="width:250px;height: 20px" />\
                    </div>\
                </div>\
                <div class="ICenqueryType">\
                <div class="form-inline ICenqueryTypeWrap">\
                <span>型号</span>\
                <input type="text"  class="form-control" name="Modle" value="" style="width:125px;margin-right:10px;height: 20px;" />\
                <span>品牌</span>\
                <input type="text"  class="form-control" name="Brand" value="" style="width:75px;margin-right:10px;height: 20px;" />\
                <span>封装</span>\
                <input type="text"  class="form-control" name="Package" value="" style="width:75px;margin-right:10px;height: 20px;" />\
                <span>年份</span>\
                <input type="text"  class="form-control dateTimePicker" name="Year" value="2018-06-18" style="width:80px;margin-right:10px;height: 20px;" />\
                </div>\
                <div class="form-inline ICenqueryTypeWrap">\
                <span>数量</span>\
                <input type="text"  class="form-control vld_int"  name="Qty" value="" style="width:125px;margin-right:10px;height: 20px;" />\
                <span>报价</span>\
                <input type="text"  class="form-control vld_decimal" name="Price" value="" style="width:75px;margin-right:10px;height: 20px;" />\
                <span>成本</span>\
                <input type="text"  class="form-control vld_decimal" name="Cost" value="" style="width:75px;margin-right:10px;height: 20px;" />\
                <span>货币</span>\
                <input type="text"  class="form-control" name="Curr" value="" style="width:80px;margin-right:10px;height: 20px;" />\
                </div>\
                <div class="form-inline ICenqueryTypeWrap">\
                <span>品质</span>\
                <input type="text"  class="form-control"  name="Quality" value="" style="width:125px;margin-right:10px;height: 20px;" />\
                <span>交期</span>\
                <input type="text" class="form-control" name="Delivery" value="2018-06-18" style="width:75px;margin-right:10px;height: 20px;" />\
                </div>\
                <div class="form-inline ICenqueryTypeWrap">\
                <span>备注</span>\
				<textarea name="Remark" style="width: 557px;height: 60px;margin-right:10px;" class="form-control"></textarea>\
                </div>\
                </div>\
                </form>\
            </div>\
            <div class="modal-footer">\
                ' + (tbc ? '<a href="javascript:void(0)" class="ic-btn ic-btn-default ICSaveEnquery" data-tbc="1">待确认报价</a>' : '') + '\
                <a href="javascript:void(0)" class="ic-btn ic-btn-info ICSaveEnquery" data-tbc="0">直接报价</a>\
            </div>\
            </div>\
        </div>\
    </div>');
    ...
    //设置模态框可拖动
    $("#ERP_ICEnquery").on("show.bs.modal", function() {
        $(this).find(".modal-content").draggable()
    });
    $("#ERP_ICEnquery").on("hidden.bs.modal", function() {
    ...
    // ajax调用方法
    function ajaxFun(url, type, data, successback, errorback) {
        $.ajax({
            url: url,
            type: type,
            data: data,
    ...
    $(".vld_decimal").keyup(function() {
        var n = parseInt(this.dataset.decimalcount) || 5;
    ...
    if (hostname == "www.ic.net.cn") { //ic交易网
        $('input[name="Remark"]').css("width", "588px");
        $('input[name="Address"]').css("width", "588px");
        $('#IC_TelB').css("width", "546px");
    } else { //华强电子网
        $('input[name="Remark"]').css("width", "557px");
        $('input[name="Address"]').css("width", "557px");
        $('#IC_TelB').css("width", "510px");
    }

    //点击询价
    $(".customEnquryInfo").click(function(e) {
        e.stopPropagation();
        var $this = $(this);
        var QuoModle, QuoBrand, QuoPackage, QuoYear, QuoQty, QuoPrice, Cost, QuoCurr, Delivery, Remark, CardName;
        if (hostname == "www.ic.net.cn") { //ic交易网
            $("#cardName").text($this.parent().prevAll(".result_supply").children("a").text()); //模态框标题 ：供应商
            $ele = $this.parent().prevAll(".result_supply").find(".layer_mainContent");
            ...
            $('input[name="Tel1"]').val($.trim(mphone)); //联系电话
            $("#IC_TelB").val($.trim(contacts)); //供应商联系电话
            $('input[name="Address"]').val($.trim(address)); //地址
            ...
            QuoModle = $this.parent().children("span").text(); //型号
            QuoBrand = $this.parent().nextAll(".result_factory").text(); //品牌
            QuoPackage = $this.parent().nextAll(".result_pakaging").text(); //封装
            QuoYear = $this.parent().nextAll(".result_batchNumber").text(); //年份
            QuoQty = $this.parent().nextAll(".result_totalNumber").text(); //报价数量
            QuoPrice = 0; //报价价格
            Cost = 0; //报价成本
            QuoCurr = "RMB"; //报价货币
            Delivery = ""; //交期
            CardName = $this.parent().prevAll(".result_supply").children("a").text(); //供应商

            $('input[name="Modle"]').val($.trim(QuoModle));
            $('input[name="Brand"]').val($.trim(QuoBrand));
            $('input[name="Package"]').val($.trim(QuoPackage));
            $('input[name="Year"]').val($.trim(QuoYear));
            $('input[name="Qty"]').val($.trim(QuoQty));
            $('input[name="Price"]').val($.trim(QuoPrice));
            $('input[name="Cost"]').val($.trim(Cost));
    ...
    $(".ICSaveEnquery").click(function() {
        ...
        try {
            var formData = parseStrObjByRegExpKV(decodeURIComponent($("#ICenqueryInfo").serialize().replace(/\+/g, '%20'), true));
            formData.Contacts = JSON.parse(formData.Contacts);
            formData.IsTobeConfirmed = isTbc;
            //console.log(formData);
            var formDataStr = JSON.stringify(formData);
            var code = window.external.ExQuote(formDataStr);
            if (code == 0) {
                $("#ERP_ICEnquery").modal("hide");
            } else {
                // alert("保存失败！");
            }
        } catch (err) {
